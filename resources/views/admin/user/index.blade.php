@extends('admin/layout/app') @section('content') <div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4 display-inline-block">
    <span class="text-muted fw-light">
      <a href="{{url('admin/dashboard')}}">{{__('lang.admin_dashboard')}}</a> / </span> {{__('lang.admin_user')}} {{__('lang.admin_list')}}
  </h4>
      ...
      <form method="get">
        <div class="row">
          ...
          <div class="col-sm-3 display-inline-block">
            ...
            <a type="reset" class="btn btn-outline-secondary" href="{{url('admin/user')}}">{{__('lang.admin_reset')}} </a>
          </div>
        </div>
      </form>
    </div>
  ...
  <div class="card">
    <div class="card-header">
      <h5 class="card-title display-inline-block">{{__('lang.admin_user')}} {{__('lang.admin_list')}}</h5>
    ...
    <div class="table-responsive text-nowrap"> @include('admin/user/table') </div>
