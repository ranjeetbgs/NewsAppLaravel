@extends('admin/layout/app') @section('content') <div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="offcanvas offcanvas-end" id="add-new-record">
    ...
    <div class="offcanvas-body flex-grow-1">
      <form class="add-new-record pt-0 row g-2" id="add-record" onsubmit="return validateSubadmin('add-record');" action="{{url('admin/add-sub-admin')}}" method="POST" enctype="multipart/form-data"> @csrf 
        <div class="col-sm-12">
          <div class="mb-1">
            <label class="form-label" for="name">{{__('lang.admin_name')}} <span class="required">*</span></label>
            <input type="text" class="form-control" id="name" placeholder="{{__('lang.admin_name_placeholder')}}" name="name">
          </div>
        </div>
        <div class="col-sm-12">
          <div class="mb-1">
            <label class="form-label" for="email">{{__('lang.admin_email')}} <span class="required">*</span></label>
            <input type="email" class="form-control" id="email" placeholder="{{__('lang.admin_email_placeholder')}}" name="email">
          </div>
        </div>
        <div class="col-sm-12">
          <div class="mb-1">
        ...
        <div class="col-sm-12">
          <div class="mb-1">
            ...
            <div class="d-flex">
              <img src="" class="rounded me-50 hide" id="image-preview" alt="photo" height="80" width="80"/>
