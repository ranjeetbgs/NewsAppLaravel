...
use App\Http\Requests\SubAdmin\StoreSocialMediaLinkRequest;
use App\Http\Requests\SubAdmin\UpdateSocialMediaLinkRequest;
...
class SocialMediaLinkController extends Controller
{
    ...
    public function store(StoreSocialMediaLinkRequest $request)
    {
        try{
            ...
            if($added['status']==true){
                return redirect('admin/social-media')->with('success', $added['message']); 
            }
            else{
    ...
    public function update(UpdateSocialMediaLinkRequest $request, SocialMediaLink $SocialMediaLink)
    {
        try{
            ...
            if($updated['status']==true){
                return redirect('admin/social-media')->with('success', $updated['message']); 
            }
            else{
    ...
    **/
    ...
    {
        try{
            $updated = SocialMediaLink::updateColumn($id,$name,$value);
            if($updated['status']==true){
