...
(function () {
  ...
  if (typeof salesLastYearEl !== undefined && salesLastYearEl !== null) {
   ...
   // Sales last year Area Chart
  // --------------------------------------------------------------------
  const salesLastYearEl1 = document.querySelector('.salesLastYear'),
  ...
  if (typeof salesLastYearEl1 !== undefined && salesLastYearEl1 !== null) {
    const salesLastYear1 = new ApexCharts(salesLastYearEl1, salesLastYearConfig1);
    salesLastYear1.render();
  }

  const salesLastYearEl2 = document.querySelector('.salesLastYear2'),
    salesLastYearConfig2 = {
      chart: {
        height: 78,
        type: 'area',
        parentHeightOffset: 0,
  ...
  if (typeof salesLastYearEl2 !== undefined && salesLastYearEl2 !== null) {
    const salesLastYear2 = new ApexCharts(salesLastYearEl2, salesLastYearConfig2);
    salesLastYear2.render();
  }

  const salesLastYearEl3 = document.querySelector('.salesLastYear3'),
    salesLastYearConfig3 = {
      chart: {
        height: 78,
        type: 'area',
        parentHeightOffset: 0,
  ...
  if (typeof salesLastYearEl3 !== undefined && salesLastYearEl3 !== null) {
    const salesLastYear3 = new ApexCharts(salesLastYearEl3, salesLastYearConfig3);
    salesLastYear3.render();
  }
