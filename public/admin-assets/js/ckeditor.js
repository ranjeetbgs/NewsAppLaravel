	...
	return function(e) {
		...
		class Wo {
			...
			createAttributeElement(e, t, i = {}) {
				...
				return "number" == typeof i.priority && (n._priority = i.priority), i.id && (n._id = i.id), n
			}
		...
		function rr(e) {
			return er(e) && e.data.substr(0, 7) === or
		}

		function sr(e) {
			return 7 == e.data.length && rr(e)
		}

		function ar(e) {
			return rr(e) ? e.data.slice(7) : e.data
		}
		...
		function cr(e, t) {
			if (t.keyCode == Io.arrowleft) {
				...
				if (1 == e.rangeCount && e.getRangeAt(0).collapsed) {
					...
					rr(t) && i <= 7 && e.collapse(t, 0)
				}
			}
		}

		function lr(e, t, i, n = !1) {
			i = i || function(e, t) {
				return e === t
		...
		function hr(e, t, i) {
			...
			const n = e.length,
				o = t.length;
			if (n > 200 || o > 200 || n + o > 300) return hr.fastDiff(e, t, i, !0);
			let r, s;
			if (o < n) {
				const i = e;
		...
		class pr {
			...
			render() {
				...
				if (e) {
					...
					rr(t.parent) ? this._inlineFiller = t.parent : this._inlineFiller = br(i, t.parent, t.offset)
			...
			_updateChildrenMappings(e) {
				...
				if (!t) return;
				const i = Array.from(this.domConverter.mapViewToDom(e).childNodes),
					...
					for (const o of r)
						if ("replace" === o) {
							const o = t.equal + t.insert,
								r = t.equal + t.delete,
								s = e.getChild(o);
							!s || s.is("uiElement") || s.is("rawElement") || this._updateElementMappings(s, i[r]), gr(n[o]), t.equal++
						} else t[o]++
				}
			}
			...
			_isSelectionInInlineFiller() {
				...
				return !!(t && er(t.parent) && rr(t.parent))
			}
			_removeInlineFiller() {
				const e = this._inlineFiller;
				if (!rr(e)) throw new c.a("view-renderer-filler-was-lost", this);
				sr(e) ? e.parentNode.removeChild(e) : e.data = e.data.substr(7), this._inlineFiller = null
			}
			...
			_updateText(e, t) {
				...
				if (s && s.parent == e.parent && s.offset == e.index && (r = or + r), o != r) {
					const e = lr(o, r);
			...
			_updateChildren(e, t) {
				...
				n && n.parent === e && br(i.ownerDocument, r, n.offset);
				const s = this._diffNodeLists(o, r);
				let a = 0;
				const c = new Set;
				for (const e of s) "delete" === e ? (c.add(o[a]), gr(o[a])) : "equal" === e && a++;
				a = 0;
				for (const e of s) "insert" === e ? (fr(i, a, r[a]), a++) : "equal" === e && (this._markDescendantTextToSync(this.domConverter.domToView(r[a])), a++);
			...
			_diffNodeLists(e, t) {
				return hr(e = function(e, t) {
					...
					return i
				}(e, this._fakeSelectionContainer), t, kr.bind(null, this.domConverter))
			}
			_findReplaceActions(e, t, i) {
				...
				for (const a of e) "insert" === a ? r.push(i[s.equal + s.insert]) : "delete" === a ? o.push(t[s.equal + s.delete]) : (n = n.concat(hr(o, r, wr).map(e => "equal" === e ? "replace" : e)), n.push("equal"), o = [], r = []), s[a]++;
				return n.concat(hr(o, r, wr).map(e => "equal" === e ? "replace" : e))
			}
		...
		function br(e, t, i) {
			const n = t instanceof Array ? t : t.childNodes,
				o = n[i];
			if (er(o)) return o.data = or + o.data, o; {
				const o = e.createTextNode(or);
				return Array.isArray(t) ? n.splice(i, 0, o) : fr(t, i, o), o
			}
		}

		function wr(e, t) {
			return mr(e) && mr(t) && !er(e) && !er(t) && e.nodeType !== Node.COMMENT_NODE && t.nodeType !== Node.COMMENT_NODE && e.tagName.toLowerCase() === t.tagName.toLowerCase()
		}
		...
		class Tr {
			...
			viewToDom(e, t, i = {}) {
				...
				let o = 0;
				for (const r of e.getChildren()) n === o && (yield this._getBlockFiller(t)), yield this.viewToDom(r, t, i), o++;
				n === o && (yield this._getBlockFiller(t))
			}
			viewRangeToDom(e) {
			...
			domPositionToView(e, t) {
				if (this.isBlockFiller(e)) return this.domPositionToView(e.parentNode, vr(e));
				const i = this.mapDomToView(e);
				if (i && (i.is("uiElement") || i.is("rawElement"))) return ao._createBefore(i);
				if (er(e)) {
					if (sr(e)) return this.domPositionToView(e.parentNode, vr(e));
					const i = this.findCorrespondingViewText(e);
					let n = t;
					return i ? (rr(e) && (n -= 7, n = n < 0 ? 0 : n), new ao(i, n)) : null
				}
				if (0 === t) {
			...
			isBlockFiller(e) {
				return "br" == this.blockFillerMode ? e.isEqualNode(xr) : !("BR" !== e.tagName || !Sr(e, this.blockElements) || 1 !== e.parentNode.childNodes.length) || (e.isEqualNode(Cr) || function(e, t) {
					return e.isEqualNode(Ar) && Sr(e, t) && 1 === e.parentNode.childNodes.length
			...
			_isDomSelectionPositionCorrect(e, t) {
				if (er(e) && rr(e) && t < 7) return !1;
				if (this.isElement(e) && rr(e.childNodes[t])) return !1;
				const i = this.mapDomToView(e);
			...
			_processDataFromDomText(e) {
				let t = e.data;
				if (Er(e, this.preElements)) return ar(e);
				t = t.replace(/[ \n\t\r]{1,}/g, " ");
				...
				return o && (t = t.replace(/^ /, "")), r && (t = t.replace(/ $/, "")), t = ar(new Text(t)), t = t.replace(/ \u00A0/g, "  "), (/( |\u00A0)\u00A0$/.test(t) || !n || n.data && " " == n.data.charAt(0)) && (t = t.replace(/\u00A0$/, " ")), o && (t = t.replace(/^\u00A0/, " ")), t
			}
			...
			_getTouchingInlineDomNode(e, t) {
				...
				if (null !== s) {
					...
					if (t && !Er(e, this.blockElements, t) && !Er(s, this.blockElements, t)) return s
				}
				return null
			}
		}
		...
		function Pr(e, t) {
			for (; e && e != _r.document;) t(e), e = e.parentNode
		}
		...
		var Ir = Le({}, u, {
			listenTo(e, ...t) {
				if (mr(e) || Mr(e)) {
					const i = this._getProxyEmitter(e) || new Nr(e);
					i.attach(...t), e = i
				}
			...
			stopListening(e, t, i) {
				...
				u.stopListening.call(this, e, t, i), e instanceof Nr && e.detach(t)
			},
			_getProxyEmitter(e) {
				return t = this, i = Rr(e), t[l] && t[l][i] ? t[l][i].emitter : null;
				var t, i
			}
		});
		class Nr {
			constructor(e) {
				h(this, Rr(e)), this._domNode = e
			}
		}
		...
		zr.prototype.add = zr.prototype.push = Dr, zr.prototype.has = Lr;
		var Vr = zr;
		var jr = function(e, t) {
		...
		var Fr = function(e, t, i, n, o, r) {
			...
			for (r.set(e, t), r.set(t, e); ++u < a;) {
				...
				if (f) {
					if (!jr(t, (function(e, t) {
							if (!Br(f, t) && (g === e || o(g, e, i, n, r))) return f.push(t)
						}))) {
						h = !1;
						break
					}
		...
		var Gr = function(e, t, i, n, o, r) {
				...
				for (var l = c; l--;) {
					var d = a[l];
					if (!(s ? d in t : Yr.call(t, d))) return !1
				}
				var u = r.get(e),
					h = r.get(t);
		...
		var Qr = function(e, t, i, n, o, r) {
			...
			if (h && !d) return r || (r = new Wt), s || Ee(e) ? Fr(e, t, i, n, o, r) : $r(e, t, c, i, n, o, r);
			if (!(1 & i)) {
				var f = d && Kr.call(e, "__wrapped__"),
					g = u && Kr.call(t, "__wrapped__");
				if (f || g) {
					var m = f ? e.value() : e,
						p = g ? t.value() : t;
			...
			return !!h && (r || (r = new Wt), Gr(e, t, i, n, o, r))
		};
		var Jr = function e(t, i, n, o, r) {
			return t === i || (null == t || null == i || !ge(t) && !ge(i) ? t != t && i != i : Qr(t, i, n, o, e, r))
		};
		var Zr = function(e, t, i) {
			var n = (i = "function" == typeof i ? i : void 0) ? i(e, t) : void 0;
			return void 0 === n ? Jr(e, t, void 0, i) : !!n
		};
		class Xr extends Or {
			constructor(e) {
			...
			_onMutations(e) {
				...
				for (const i of e)
					...
					if ((!e || !e.is("uiElement") && !e.is("rawElement")) && "characterData" === o.type) {
						...
						e && !n.has(e.parent) ? i.set(e, {
							...
							newText: ar(o.target),
							node: e
						}) : !e && rr(o.target) && n.add(t.mapDomToView(o.target.parentNode))
					}
				}
				const o = [];
				...
				for (const e of n) {
					...
					Zr(n, r, a) || (this.renderer.markToSync("children", e), o.push({
						type: "children",
						oldChildren: n,
						newChildren: r,
						node: e
		...
		var rs = function(e) {
			...
			ss = /^\s+/;
		var as = function(e) {
				return e ? e.slice(0, rs(e) + 1).replace(ss, "") : e
			},
			cs = /^[-+]0x[0-9a-f]+$/i,
			ls = /^0b[01]+$/i,
			ds = /^0o[0-7]+$/i,
		...
		var hs = function(e) {
				...
				e = as(e);
				var i = ls.test(e);
				return i || ds.test(e) ? us(e.slice(2), i ? 2 : 8) : cs.test(e) ? NaN : +e
			},
			fs = Math.max,
			gs = Math.min;
		var ms = function(e, t, i) {
			var n, o, r, s, a, c, l = 0,
				d = !1,
				u = !1,
				h = !0;
			...
			return t = hs(t) || 0, w(i) && (d = !!i.leading, r = (u = "maxWait" in i) ? fs(hs(i.maxWait) || 0, t) : r, h = "trailing" in i ? !!i.trailing : h), k.cancel = function() {
				void 0 !== a && clearTimeout(a), l = 0, n = c = o = a = void 0
			}, k.flush = function() {
				return void 0 === a ? s : b(ns())
			}, k
		};
		class ps extends Or {
			constructor(e) {
				super(e), this._fireSelectionChangeDoneDebounced = ms(e => this.document.fire("selectionChangeDone", e), 200)
			}
			observe() {
		...
		class bs extends Or {
			constructor(e) {
				super(e), this.mutationObserver = e.getObserver(Xr), this.selection = this.document.selection, this.domConverter = e.domConverter, this._documents = new WeakSet, this._fireSelectionChangeDoneDebounced = ms(e => this.document.fire("selectionChangeDone", e), 200), this._clearInfiniteLoopInterval = setInterval(() => this._clearInfiniteLoop(), 1e3), this._loopbackCounter = 0
			}
			observe(e) {
				const t = e.ownerDocument;
		...
		class Ts {
			constructor(e) {
				...
				if (Object.defineProperty(this, "_source", {
					...
					if (t) {
						const t = Ts.getDomRangeRects(e);
						Es(this, Ts.getBoundingRect(t))
					} else Es(this, e.getBoundingClientRect());
				else if (Mr(e)) {
					const {
						innerWidth: t,
						innerHeight: i
			...
			getIntersection(e) {
				...
				return t.width = t.right - t.left, t.height = t.bottom - t.top, t.width < 0 || t.height < 0 ? null : new Ts(t)
			}
			...
			excludeScrollbarsAndBorders() {
				const e = this._source;
				let t, i, n;
				if (Mr(e)) t = e.innerWidth - e.document.documentElement.clientWidth, i = e.innerHeight - e.document.documentElement.clientHeight, n = e.getComputedStyle(e.document.documentElement).direction;
				else {
					const o = As(this._source);
			...
			static getDomRangeRects(e) {
				...
				if (i.length)
					for (const e of i) t.push(new Ts(e));
				else {
					let i = e.startContainer;
					er(i) && (i = i.parentNode);
					const n = new Ts(i.getBoundingClientRect());
			...
			static getBoundingRect(e) {
				...
				return 0 == i ? null : (t.width = t.right - t.left, t.height = t.bottom - t.top, new Ts(t))
			}
		}

		function Es(e, t) {
			for (const i of Cs) e[i] = t[i]
		}
		...
		class Ss {
			constructor(e, t) {
				Ss._observerInstance || Ss._createObserver(), this._element = e, this._callback = t, Ss._addElementCallback(e, t), Ss._observerInstance.observe(e)
			}
			destroy() {
			...
			static _addElementCallback(e, t) {
				...
				let i = Ss._elementCallbacks.get(e);
				i || (i = new Set, Ss._elementCallbacks.set(e, i)), i.add(t)
			}
			static _deleteElementCallback(e, t) {
				const i = Ss._getElementCallbacks(e);
				i && (i.delete(t), i.size || (Ss._elementCallbacks.delete(e), Ss._observerInstance.unobserve(e))), Ss._elementCallbacks && !Ss._elementCallbacks.size && (Ss._observerInstance = null, Ss._elementCallbacks = null)
			}
			...
			static _createObserver() {
				let e;
				e = "function" == typeof _r.window.ResizeObserver ? _r.window.ResizeObserver : Ms, Ss._observerInstance = new e(e => {
					for (const t of e) {
						const e = Ss._getElementCallbacks(t.target);
						if (e)
		...
		class Os {
			constructor() {
				this._listener = Object.create(Ir)
			}
			listenTo(e) {
		...
		function Ls({
			...
			for (; n;) {
				let r;
				r = Ws(n == i ? e : o), Vs(r, () => qs(e, n));
				const s = qs(e, n);
				if (zs(n, s, t), n.parent != n) {
		...
		function zs(e, t, i) {
			const n = t.clone().moveBy(0, i),
				...
				r = new Ts(e).excludeScrollbarsAndBorders();
			if (![o, n].every(e => r.contains(e))) {
				let {
					scrollX: s,
					scrollY: a
				} = e;
				Bs(o, r) ? a -= r.top - t.top + i : js(n, r) && (a += t.bottom - r.bottom + i), Fs(t, r) ? s -= r.left - t.left + i : Hs(t, r) && (s += t.right - r.right + i), e.scrollTo(s, a)
			}
		}
		...
		function Vs(e, t) {
			const i = Us(e);
			let n, o;
			for (; e != i.document.body;) o = t(), n = new Ts(e).excludeScrollbarsAndBorders(), n.contains(o) || (Bs(o, n) ? e.scrollTop -= n.top - o.top : js(o, n) && (e.scrollTop += o.bottom - n.bottom), Fs(o, n) ? e.scrollLeft -= n.left - o.left : Hs(o, n) && (e.scrollLeft += o.right - n.right)), e = e.parentNode
		}
		...
		function Us(e) {
			return xs(e) ? e.startContainer.ownerDocument.defaultView : e.ownerDocument.defaultView
		}
			...
			if (i === t) return n; {
				...
				for (; e != t;) {
					const t = e.frameElement,
						i = new Ts(t).excludeScrollbarsAndBorders();
		...
		class Qs {
			...
			_insertNodes(e, t) {
				for (const e of t)
					if (!(e instanceof Ys)) throw new c.a("model-nodelist-insertnodes-not-node", this);
		...
		class Js extends Ys {
			constructor(e, t, i) {
				super(t), this.name = e, this._children = new Qs, i && this._insertChild(0, i)
			}
			get childCount() {
				return this._children.length
			}
			...
			_clone(e = !1) {
				...
				return new Js(this.name, this.getAttributes(), t)
			}
			_appendChild(e) {
			...
			_insertChild(e, t) {
				const i = function(e) {
					if ("string" == typeof e) return [new Gs(e)];
					Ji(e) || (e = [e]);
					return Array.from(e).map(e => "string" == typeof e ? new Gs(e) : e instanceof Ks ? new Gs(e.data, e.getAttributes()) : e)
				}(t);
			...
			static fromJSON(e) {
				...
				if (e.children) {
					t = [];
					for (const i of e.children) i.name ? t.push(Js.fromJSON(i)) : t.push(Gs.fromJSON(i))
				}
				return new Js(e.name, e.attributes, t)
			}
		}
		class Zs {
			constructor(e = {}) {
			...
			_next() {
				...
				const n = t.parent,
					o = ta(t, n),
					r = o || ia(t, n, o);
				if (r instanceof Js) return this.shallow ? t.offset++ : (t.path.push(0), this._visitedParent = r), this.position = t, Xs("elementStart", r, e, t, 1);
				if (r instanceof Gs) {
					let n;
					if (this.singleCharacters) n = 1;
					else {
					...
					const o = t.offset - r.startOffset,
						s = new Ks(r, o, n);
					return t.offset += n, this.position = t, Xs("text", s, e, t, n)
				}
				return t.path.pop(), t.offset++, this.position = t, this._visitedParent = i.parent, this.ignoreElementEnd ? this._next() : Xs("elementEnd", i, e, t)
			}
			_previous() {
				const e = this.position,
					t = this.position.clone(),
				...
				const n = t.parent,
					o = ta(t, n),
					r = o || na(t, n, o);
				if (r instanceof Js) return t.offset--, this.shallow ? (this.position = t, Xs("elementStart", r, e, t, 1)) : (t.path.push(r.maxOffset), this.position = t, this._visitedParent = r, this.ignoreElementEnd ? this._previous() : Xs("elementEnd", r, e, t));
				if (r instanceof Gs) {
					let n;
					if (this.singleCharacters) n = 1;
					else {
				...
				return t.path.pop(), this.position = t, this._visitedParent = i.parent, Xs("elementStart", i, e, t, 1)
			}
		}

		function Xs(e, t, i, n, o) {
			return {
				done: !1,
				value: {
					type: e,
		...
		class ea {
			...
			get nodeAfter() {
				const e = this.parent;
				return ia(this, e, ta(this, e))
			}
			get nodeBefore() {
				const e = this.parent;
				return na(this, e, ta(this, e))
			}
			get isAtStart() {
				return 0 === this.offset
			}
			...
			isTouching(e) {
				...
				switch (this.compareWith(e)) {
					case "same":
						return !0;
					case "before":
						t = ea._createAt(this), i = ea._createAt(e);
						break;
					case "after":
						t = ea._createAt(e), i = ea._createAt(this);
						break;
					default:
						return !1
				}
			...
			_getTransformedByMergeOperation(e) {
				const t = e.movedRange;
				let i;
				return t.containsPosition(this) || t.start.isEqual(this) ? (i = this._getCombined(e.sourcePosition, e.targetPosition), e.sourcePosition.isBefore(e.targetPosition) && (i = i._getTransformedByDeletion(e.deletionPosition, 1))) : i = this.isEqual(e.deletionPosition) ? ea._createAt(e.deletionPosition) : this._getTransformedByMove(e.deletionPosition, e.graveyardPosition, 1), i
			}
			_getTransformedByDeletion(e, t) {
				const i = ea._createAt(this);
			...
			static fromJSON(e, t) {
				if ("$graveyard" === e.root) {
					const i = new ea(t.graveyard, e.path);
		...
		class oa {
			constructor(e, t = null) {
				this.start = ea._createAt(e), this.end = t ? ea._createAt(t) : ea._createAt(e), this.start.stickiness = this.isCollapsed ? "toNone" : "toNext", this.end.stickiness = this.isCollapsed ? "toNone" : "toPrevious"
			}*[Symbol.iterator]() {
				yield* new Zs({
					boundaries: this,
					ignoreElementEnd: !0
			...
			getDifference(e) {
				const t = [];
				return this.isIntersecting(e) ? (this.containsPosition(e.start) && t.push(new oa(this.start, e.start)), this.containsPosition(e.end) && t.push(new oa(e.end, this.end))) : t.push(new oa(this.start, this.end)), t
			}
			getIntersection(e) {
				if (this.isIntersecting(e)) {
					let t = this.start,
						i = this.end;
					return this.containsPosition(e.start) && (t = e.start), this.containsPosition(e.end) && (i = e.end), new oa(t, i)
				}
				return null
			}
			getJoined(e, t = !1) {
				...
				let n = this.start,
					o = this.end;
				return e.start.isBefore(n) && (n = e.start), e.end.isAfter(o) && (o = e.end), new oa(n, o)
			}
			getMinimalFlatRanges() {
				const e = [],
					t = this.start.getCommonPath(this.end).length,
					i = ea._createAt(this.start);
				let n = i.parent;
				for (; i.path.length > t + 1;) {
					const t = n.maxOffset - i.offset;
					0 !== t && e.push(new oa(i, i.getShiftedBy(t))), i.path = i.path.slice(0, -1), i.offset++, n = n.parent
				}
				for (; i.path.length <= this.end.path.length;) {
					const t = this.end.path[i.path.length - 1],
						n = t - i.offset;
					0 !== n && e.push(new oa(i, i.getShiftedBy(n))), i.offset = t, i.path.push(0)
				}
				return e
			}
			getWalker(e = {}) {
			...
			getTransformedByOperations(e) {
				const t = [new oa(this.start, this.end)];
				for (const i of e)
			...
			_getTransformedBySplitOperation(e) {
				...
				return this.end.isEqual(e.insertionPosition) && (i = this.end.getShiftedBy(1)), t.root != i.root && (i = this.end.getShiftedBy(-1)), new oa(t, i)
			}
			_getTransformedByMergeOperation(e) {
				...
				return t.root != i.root && (i = this.end.getShiftedBy(-1)), t.isAfter(i) ? (e.sourcePosition.isBefore(e.targetPosition) ? (t = ea._createAt(i), t.offset = 0) : (e.deletionPosition.isEqual(t) || (i = e.deletionPosition), t = e.targetPosition), new oa(t, i)) : new oa(t, i)
			}
			_getTransformedByInsertion(e, t, i = !1) {
				if (i && this.containsPosition(e)) return [new oa(this.start, e), new oa(e.getShiftedBy(t), this.end._getTransformedByInsertion(e, t))]; {
					const i = new oa(this.start, this.end);
			...
			_getTransformedByMove(e, t, i, n = !1) {
				...
				const o = oa._createFromPositionAndShift(e, i),
				...
				if (1 == a.length ? c = new oa(a[0].start._getTransformedByDeletion(e, i), a[0].end._getTransformedByDeletion(e, i)) : 2 == a.length && (c = new oa(this.start, this.end._getTransformedByDeletion(e, i))), s = c ? c._getTransformedByInsertion(r, i, null !== l || n) : [], l) {
					const e = new oa(l.start._getCombined(o.start, r), l.end._getCombined(o.start, r));
			...
			_getTransformedByDeletion(e, t) {
				...
				return null == i && null == n ? null : (null == i && (i = e), null == n && (n = e), new oa(i, n))
			}
			static _createFromPositionAndShift(e, t) {
				const i = e,
					n = e.getShiftedBy(t);
			...
			static _createFromRanges(e) {
				...
				if (i > 0)
					for (let t = i - 1; e[t].end.isEqual(n.start); t++) n.start = ea._createAt(e[t].start);
				for (let t = i + 1; t < e.length && e[t].start.isEqual(n.end); t++) n.end = ea._createAt(e[t].end);
				return n
			}
			static fromJSON(e, t) {
		...
		class ra {
			constructor() {
				this._modelToViewMapping = new WeakMap, this._viewToModelMapping = new WeakMap, this._viewToModelLengthCallbacks = new Map, this._markerNameToElements = new Map, this._elementToMarkerNames = new Map, this._unboundMarkerNames = new Set, this.on("modelToViewPosition", (e, t) => {
					...
					t.modelPosition = ea._createAt(n, o)
				}, {
					priority: "low"
				})
			}
		...
		class ca {
			...
			convertChanges(e, t, i) {
				...
				for (const e of n) "insert" === e.type ? this.convertInsert(oa._createFromPositionAndShift(e.position, e.length), i) : "remove" === e.type ? this.convertRemove(e.position, e.length, e.name, i) : "reconvert" === e.type ? this.reconvertElement(e.element, i) : this.convertAttribute(e.range, e.attributeKey, e.attributeOldValue, e.attributeNewValue, i);
			...
			convertInsert(e, t) {
				...
				for (const t of Array.from(e).map(da)) this._convertInsertWithAttributes(t);
			...
			convertAttribute(e, t, i, n, o) {
				...
				for (const o of e) {
					const e = {
						item: o.item,
						range: oa._createFromPositionAndShift(o.previousPosition, o.length),
						attributeKey: t,
						attributeOldValue: i,
						attributeNewValue: n
					};
			...
			reconvertElement(e, t) {
				...
				for (const i of oa._createIn(e)) {
					const {
						item: e
					} = i, o = ua(e, n);
					o ? o.root !== r.root && t.move(t.createRangeOn(o), n.toViewPosition(ea._createBefore(e))) : this._convertInsertWithAttributes(da(i))
				}
			...
			convertSelection(e, t, i) {
				...
				if (this.conversionApi.writer = i, this.conversionApi.consumable = this._createSelectionConsumable(e, n), this.fire("selection", {
					...
					for (const t of n) {
						const i = t.getRange();
						if (!la(e.getFirstPosition(), t, this.conversionApi.mapper)) continue;
						const n = {
							item: e,
							markerName: t.name,
							markerRange: i
			...
			_mapChangesWithAutomaticReconversion(e) {
				...
				for (const n of e.getChanges()) {
					...
					const r = "attribute" === n.type ? ia(e, o, null) : o;
					if (r.is("$text")) {
						i.push(n);
						continue
					}
		...
		function da(e) {
			return {
				item: e.item,
				range: oa._createFromPositionAndShift(e.previousPosition, e.length)
			}
		}

		function ua(e, t) {
			if (e.is("textProxy")) {
				const i = t.toViewPosition(ea._createBefore(e)).parent;
		...
		class ha {
			...
			isEqual(e) {
				...
				for (const e of this._ranges) yield new oa(e.start, e.end)
			}
			getFirstRange() {
				let e = null;
				for (const t of this._ranges) e && !t.start.isBefore(e.start) || (e = t);
				return e ? new oa(e.start, e.end) : null
			}
			getLastRange() {
				let e = null;
				for (const t of this._ranges) e && !t.end.isAfter(e.end) || (e = t);
			...
			setTo(e, t, i) {
				...
				else if (e instanceof ha) this._setRanges(e.getRanges(), e.isBackward);
				else if (e && "function" == typeof e.getRanges) this._setRanges(e.getRanges(), e.isBackward);
				else if (e instanceof oa) this._setRanges([e], !!t && !!t.backward);
				else if (e instanceof ea) this._setRanges([new oa(e)]);
				else if (e instanceof Ys) {
					const n = !!i && !!i.backward;
					let o;
					if ("in" == t) o = oa._createIn(e);
					else if ("on" == t) o = oa._createOn(e);
					else {
						if (void 0 === t) throw new c.a("model-selection-setto-required-second-parameter", [this, e]);
						o = new oa(ea._createAt(e, t))
					}
					this._setRanges([o], n)
				} else {
			...
			_setRanges(e, t = !1) {
				const i = (e = Array.from(e)).some(t => {
					if (!(t instanceof oa)) throw new c.a("model-selection-set-ranges-not-range", [this, e]);
			...
			setFocus(e, t) {
				...
				const i = ea._createAt(e, t);
				if ("same" == i.compareWith(this.focus)) return;
				const n = this.anchor;
				this._ranges.length && this._popRange(), "before" == i.compareWith(n) ? (this._pushRange(new oa(i, n)), this._lastRangeBackward = !0) : (this._pushRange(new oa(n, i)), this._lastRangeBackward = !1), this.fire("change:range", {
					directChange: !0
				})
			}
			getAttribute(e) {
			...
			is(e) {
				...
				for (const t of this.getRanges()) {
					const i = ma(t.start, e);
					i && pa(i, t) && (yield i);
					for (const i of t.getWalker()) {
						const n = i.item;
						"elementEnd" == i.type && ga(n, e, t) && (yield n)
					}
					const n = ma(t.end, e);
					n && !t.end.isTouching(ea._createAt(n, 0)) && pa(n, t) && (yield n)
				}
			}
			containsEntireContent(e = this.anchor.root) {
				const t = ea._createAt(e, 0),
					i = ea._createAt(e, "end");
		...
		function ma(e, t) {
			...
			let o = !1;
			const r = n.find(e => !o && (o = i.isLimit(e), !o && fa(e, t)));
		...
		function pa(e, t) {
			...
			if (!i) return !0;
			return !t.containsRange(oa._createOn(i), !0)
		}
		Ke(ha, u);
		class ba extends oa {
			constructor(e, t) {
				super(e, t), wa.call(this)
			}
			detach() {
				this.stopListening()
			}
		...
		function wa() {
			this.listenTo(this.root.document.model, "applyOperation", (e, t) => {
				const i = t[0];
				i.isDocumentOperation && ka.call(this, i)
			}, {
				priority: "low"
			})
		}
		...
		class _a {
			constructor(e) {
				this._selection = new va(e), this._selection.delegate("change:range").to(this), this._selection.delegate("change:attribute").to(this), this._selection.delegate("change:marker").to(this)
			}
			get isCollapsed() {
				return this._selection.isCollapsed
			}
		...
		class va extends ha {
			...
			_getSurroundingAttributes() {
				...
				if (this.isCollapsed) {
					...
					if (this.isGravityOverridden || (i = ya(n)), i || (i = ya(o)), !this.isGravityOverridden && !i) {
						let e = n;
						for (; e && !t.isInline(e) && !i;) e = e.previousSibling, i = ya(e)
					}
					if (!i) {
						let e = o;
						for (; e && !t.isInline(e) && !i;) e = e.nextSibling, i = ya(e)
					}
		...
		function ya(e) {
			return e instanceof Ks || e instanceof Gs ? e.getAttributes() : null
		}
		class xa {
			constructor(e) {
				this._dispatchers = e
		...
		class Ca extends xa {
			elementToElement(e) {
				return this.add(function(e) {
					return (e = Aa(e)).view = Pa(e.view, "container"), t => {
						var i;
			...
			attributeToElement(e) {
				return this.add(function(e) {
					...
					if (e.model.values)
						for (const t of e.model.values) e.view[t] = Pa(e.view[t], "attribute");
					else e.view = Pa(e.view, "attribute");
					const i = Sa(e);
					return n => {
						n.on(t, function(e) {
							return (t, i, n) => {
								...
								if (i.item instanceof ha || i.item instanceof _a) s.wrap(a.getFirstRange(), r);
								else {
			...
			attributeToAttribute(e) {
				return this.add(function(e) {
					...
					e.model.name && (t += ":" + e.model.name);
					if (e.model.values)
						for (const t of e.model.values) e.view[t] = Ma(e.view[t]);
					else e.view = Ma(e.view);
					const i = Sa(e);
					return n => {
						var o;
						n.on(t, (o = i, (e, t, i) => {
			...
			markerToElement(e) {
				return this.add(function(e) {
					return (e = Aa(e)).view = Pa(e.view, "ui"), t => {
						var i;
			...
			markerToHighlight(e) {
				return this.add(function(e) {
					return t => {
						...
						t.on("addMarker:" + e.model, (i = e.view, (e, t, n) => {
							if (!t.item) return;
							if (!(t.item instanceof ha || t.item instanceof _a || t.item.is("$textProxy"))) return;
							const o = Ia(i, t, n);
							if (!o) return;
							if (!n.consumable.consume(t.item, e.name)) return;
							const r = n.writer,
							...
							if (t.item instanceof ha || t.item instanceof _a) r.wrap(a.getFirstRange(), s, a);
							else {
							...
							return (t, i, n) => {
								if (!i.item) return;
								if (!(i.item instanceof Js)) return;
								const o = Ia(e, i, n);
								if (!o) return;
								...
								if (r && r.getCustomProperty("addHighlight")) {
									...
									for (const e of oa._createIn(i.item)) n.consumable.consume(e.item, t.name);
				...
				return this.add(function(e) {
					...
					return i => {
						...
						i.on("addMarker:" + t, (n = e.view, (e, t, i) => {
							...
							i.consumable.consume(r, e.name) && (Ea(r, !1, i, t, o), Ea(r, !0, i, t, o), e.stop())
						}), {
							priority: e.converterPriority || "normal"
		...
		function Ta(e, t) {
			...
			return t.classes && i._addClass(t.classes), "number" == typeof t.priority && (i._priority = t.priority), i._id = t.id, i
		}

		function Ea(e, t, i, n, o) {
		...
		class Da extends xa {
			...
			dataToMarker(e) {
				return this.add(function(e) {
					(e = Aa(e)).model || (e.model = t => t ? e.view + ":" + t : e.view);
					const t = Va(Fa(e, "start")),
						i = Va(Fa(e, "end"));
					return n => {
						...
						n.on("element", function(e) {
							return (t, i, n) => {
								...
								})) && (i.modelRange || Object.assign(i, n.convertChildren(i.viewItem, i.modelCursor)), n.consumable.consume(i.viewItem, {
									attributes: o + "-end-after"
		...
		function Ba(e, t) {
			...
			return (n, o, r) => {
				...
				if (! function(e, t) {
						...
						if ("object" == typeof i && !za(i)) return !1;
				...
				(function(e, t, i, n) {
					...
					for (const r of Array.from(e.getItems({
							shallow: i
						}))) n.schema.checkAttribute(r, t.key) && (o = !0, r.hasAttribute(t.key) || n.writer.setAttribute(t.key, t.value, r));
					return o
				})(o.modelRange, {
					key: a,
					value: c
		...
		class Ha {
			constructor(e, t) {
				this.model = e, this.view = new $s(t), this.mapper = new ra, this.downcastDispatcher = new ca({
					mapper: this.mapper,
					schema: e.schema
				});
		...
		class Wa {
			...
			add(e, t) {
				let i;
				e.is("$text") || e.is("documentFragment") ? this._consumables.set(e, !0) : (this._consumables.has(e) ? i = this._consumables.get(e) : (i = new qa(e), this._consumables.set(e, i)), i.add(t))
			}
			test(e, t) {
			...
			static createFrom(e, t) {
				...
				for (const i of e.getChildren()) t = Wa.createFrom(i, t);
				return t
			}
		}
		class qa {
		...
		class $a {
			constructor() {
				this._sourceDefinitions = {}, this._attributeProperties = {}, this.decorate("checkChild"), this.decorate("checkAttribute"), this.on("checkAttribute", (e, t) => {
					...
					t[0] = new Ya(t[0]), t[1] = this.getDefinition(t[1])
				}, {
					priority: "highest"
				})
			}
			...
			checkMerge(e, t = null) {
				if (e instanceof ea) {
					const t = e.nodeBefore,
						i = e.nodeAfter;
					if (!(t instanceof Js)) throw new c.a("schema-check-merge-no-element-before", this);
					if (!(i instanceof Js)) throw new c.a("schema-check-merge-no-element-after", this);
			...
			getLimitElement(e) {
				let t;
				if (e instanceof ea) t = e.parent;
				else {
					t = (e instanceof oa ? [e] : Array.from(e.getRanges())).reduce((e, t) => {
			...
			checkAttributeInSelection(e, t) {
				if (e.isCollapsed) {
					const i = [...e.getFirstPosition().getAncestors(), new Gs("", e.getAttributes())];
			...
			getNearestSelectionRange(e, t = "both") {
				...
				"both" != t && "backward" != t || (i = new Zs({
					boundaries: oa._createIn(o),
					startPosition: e,
					direction: "backward"
				})), "both" != t && "forward" != t || (n = new Zs({
					boundaries: oa._createIn(o),
					startPosition: e
				}));
				for (const e of function*(e, t) {
					...
					const t = e.walker == i ? "elementEnd" : "elementStart",
						n = e.value;
					if (n.type == t && this.isObject(n.item)) return oa._createOn(n.item);
					if (this.checkChild(n.nextPosition, "$text")) return new oa(n.nextPosition)
				}
				return null
			}
			...
			removeDisallowedAttributes(e, t) {
				for (const i of e)
					if (i.is("$text")) sc(this, i, t);
					else {
						const e = oa._createIn(i).getPositions();
						for (const i of e) {
							sc(this, i.nodeBefore || i.parent, t)
						}
					}
			}
			createContext(e) {
			...
			_compile() {
				const e = {},
					...
					i = Object.keys(t);
				for (const n of i) e[n] = Ga(t[n], n);
				for (const t of i) Ka(e, t);
				for (const t of i) Qa(e, t);
				for (const t of i) Ja(e, t);
				for (const t of i) Za(e, t), Xa(e, t);
				for (const t of i) ec(e, t), tc(e, t), ic(e, t);
			...
			_checkContextMatch(e, t, i = t.length - 1) {
				...
				for (const o of e.getItems({
						shallow: !0
					})) o.is("element") && (yield* this._getValidRangesForRange(oa._createIn(o), t)), this.checkAttribute(o, t) || (i.isEqual(n) || (yield new oa(i, n)), i = ea._createAfter(o)), n = ea._createAfter(o);
				i.isEqual(n) || (yield new oa(i, n))
			}
		}
		Ke($a, Ue);
		class Ya {
		...
		function Ga(e, t) {
			...
			return function(e, t) {
				...
				}(e, i), nc(e, i, "allowIn"), nc(e, i, "allowContentOf"), nc(e, i, "allowWhere"), nc(e, i, "allowAttributes"), nc(e, i, "allowAttributesOf"), nc(e, i, "allowChildren"), nc(e, i, "inheritTypesFrom"),
				function(e, t) {
					for (const i of e) {
		...
		function tc(e, t) {
			const i = e[t];
			for (const n of i.allowIn) {
				e[n].allowChildren.push(t)
			}
		}
		...
		class ac {
			...
			_convertItem(e, t) {
				...
				if (e.is("element") ? this.fire("element:" + e.name, i, this.conversionApi) : e.is("$text") ? this.fire("text", i, this.conversionApi) : this.fire("documentFragment", i, this.conversionApi), i.modelRange && !(i.modelRange instanceof oa)) throw new c.a("view-conversion-dispatcher-incorrect-result", this);
				return {
			...
			_convertChildren(e, t) {
				let i = t.is("position") ? t : ea._createAt(t, 0);
				const n = new oa(i);
				for (const t of Array.from(e.getChildren())) {
					const e = this._convertItem(t, i);
					e.modelRange instanceof oa && (n.end = e.modelRange.end, i = e.modelCursor)
				}
				return {
					modelRange: n,
					modelCursor: i
		...
		class lc {
			constructor(e) {
				this._domParser = new DOMParser, this._domConverter = new Tr(e, {
		...
		class dc {
			constructor(e, t) {
				this.model = e, this.mapper = new ra, this.downcastDispatcher = new ca({
					mapper: this.mapper,
					schema: e.schema
					...
					schema: e.schema
				}), this.viewDocument = new vo(t), this.stylesProcessor = t, this.htmlProcessor = new lc(this.viewDocument), this.processor = this.htmlProcessor, this._viewWriter = new Wo(this.viewDocument), this.upcastDispatcher.on("text", (e, t, {
					schema: i,
					consumable: n,
					writer: o
				}) => {
			...
			toView(e, t = {}) {
				...
				const o = oa._createIn(e),
					r = new Uo(i);
				this.mapper.bindElements(e, r), this.downcastDispatcher.conversionApi.options = t, this.downcastDispatcher.convertInsert(o, n);
				const s = e.is("documentFragment") ? Array.from(e.markers) : function(e) {
					const t = [],
						i = e.root.document;
					if (!i) return [];
					const n = oa._createIn(e);
				...
				for (const [e, t] of s) this.downcastDispatcher.convertMarkerAdd(e, t, n);
		...
		class uc {
			...
			elementToElement(e) {
				...
				for (const {
					...
					of hc(e)) this.for("upcast").elementToElement({
					model: t,
					view: i,
			...
			attributeToElement(e) {
				...
				for (const {
					...
					of hc(e)) this.for("upcast").elementToAttribute({
					view: i,
					model: t,
					converterPriority: e.converterPriority
				})
			...
			attributeToAttribute(e) {
				...
				for (const {
					...
					of hc(e)) this.for("upcast").attributeToAttribute({
					view: i,
					model: t
				})
			}
		...
		function* hc(e) {
			if (e.model.values)
				for (const t of e.model.values) {
					...
					yield* fc(i, n, o)
				} else yield* fc(e.model, e.view, e.upcastAlso)
		}
		...
		class pc {
			constructor(e) {
				this.markers = new Map, this._children = new Qs, e && this._insertChild(0, e)
			} [Symbol.iterator]() {
			...
			static fromJSON(e) {
				const t = [];
				for (const i of e) i.name ? t.push(Js.fromJSON(i)) : t.push(Gs.fromJSON(i));
				return new pc(t)
			}
			_appendChild(e) {
				this._insertChild(this.childCount, e)
		...
		function bc(e, t) {
			const i = (t = _c(t)).reduce((e, t) => e + t.offsetSize, 0),
				n = e.parent;
			yc(e);
			const o = e.index;
			return n._insertChild(o, t), vc(n, o + t.length), vc(n, o), new oa(e, e.getShiftedBy(i))
		}
		...
		function wc(e) {
			...
			return vc(t, e.start.index), i
		}

		function kc(e, t) {
			if (!e.isFlat) throw new c.a("operation-utils-move-range-not-flat", this);
			const i = wc(e);
			return bc(t = t._getTransformedByDeletion(e.start, e.end.offset - e.start.offset), i)
		}
		...
		function _c(e) {
			...
			for (let i = 0; i < e.length; i++)
				if ("string" == typeof e[i]) t.push(new Gs(e[i]));
				else if (e[i] instanceof Ks) t.push(new Gs(e[i].data, e[i].getAttributes()));
			else if (e[i] instanceof pc || e[i] instanceof Qs)
				for (const n of e[i]) t.push(n);
			else e[i] instanceof Ys && t.push(e[i]);
			for (let e = 1; e < t.length; e++) {
				const i = t[e],
					n = t[e - 1];
				i instanceof Gs && n instanceof Gs && xc(i, n) && (t.splice(e - 1, 2, new Gs(n.data + i.data, n.getAttributes())), e--)
			}
			return t
		}
		...
		function vc(e, t) {
			const i = e.getChild(t - 1),
				n = e.getChild(t);
			if (i && n && i.is("$text") && n.is("$text") && xc(i, n)) {
				const o = new Gs(i.data + n.data, i.getAttributes());
		...
		function yc(e) {
			...
			if (t) {
				...
				const r = new Gs(t.data.substr(0, n), t.getAttributes()),
					s = new Gs(t.data.substr(n), t.getAttributes());
		...
		class Cc extends mc {
			...
			_validate() {
				...
				for (const e of this.range.getItems({
					...
					if (null !== this.oldValue && !Ac(e.getAttribute(this.key), this.oldValue)) throw new c.a("attribute-operation-wrong-old-value", this, {
						item: e,
						key: this.key,
						value: this.oldValue
					});
			...
			_execute() {
				Ac(this.oldValue, this.newValue) || function(e, t, i) {
					yc(e.start), yc(e.end);
					for (const n of e.getItems({
							shallow: !0
						})) {
						const e = n.is("$textProxy") ? n.textNode : n;
						null !== i ? e._setAttribute(t, i) : e._removeAttribute(t), vc(e.parent, e.index)
					}
					vc(e.end.parent, e.end.index)
		...
		class Ec extends mc {
			...
			static fromJSON(e, t) {
				const i = ea.fromJSON(e.sourcePosition, t),
					n = ea.fromJSON(e.targetPosition, t);
				return new this(i, e.howMany, n, e.baseVersion)
			}
		}
		class Pc extends mc {
			constructor(e, t, i) {
				super(i), this.position = e.clone(), this.position.stickiness = "toNone", this.nodes = new Qs(_c(t)), this.shouldReceiveAttributes = !1
			}
			get type() {
				return "insert"
			}
			...
			clone() {
				const e = new Qs([...this.nodes].map(e => e._clone(!0))),
					t = new Pc(this.position, e, this.baseVersion);
				return t.shouldReceiveAttributes = this.shouldReceiveAttributes, t
			}
			getReversed() {
				const e = this.position.root.document.graveyard,
					t = new ea(e, [0]);
				return new Ec(this.position, this.nodes.maxOffset, t, this.baseVersion + 1)
			}
			_validate() {
			...
			_execute() {
				const e = this.nodes;
				this.nodes = new Qs([...e].map(e => e._clone(!0))), bc(this.position, e)
			}
			toJSON() {
				const e = super.toJSON();
			...
			static fromJSON(e, t) {
				const i = [];
				for (const t of e.nodes) t.name ? i.push(Js.fromJSON(t)) : i.push(Gs.fromJSON(t));
				const n = new Pc(ea.fromJSON(e.position, t), i, e.baseVersion);
		...
		class Mc extends mc {
			...
			clone() {
				return new Mc(this.position.clone(), this.oldName, this.newName, this.baseVersion)
			}
			getReversed() {
				return new Mc(this.position.clone(), this.newName, this.oldName, this.baseVersion + 1)
			}
			_validate() {
				const e = this.position.nodeAfter;
				if (!(e instanceof Js)) throw new c.a("rename-operation-wrong-position", this);
			...
			static fromJSON(e, t) {
				return new Mc(ea.fromJSON(e.position, t), e.oldName, e.newName, e.baseVersion)
			}
		}
		class Ic extends mc {
			constructor(e, t, i, n, o) {
			...
			clone() {
				return new Ic(this.root, this.key, this.oldValue, this.newValue, this.baseVersion)
			}
			getReversed() {
				return new Ic(this.root, this.key, this.newValue, this.oldValue, this.baseVersion + 1)
			}
			_validate() {
			...
			static fromJSON(e, t) {
				...
				return new Ic(t.getRoot(e.root), e.key, e.oldValue, e.newValue, e.baseVersion)
			}
		}
		class Nc extends mc {
			constructor(e, t, i, n, o) {
			...
			get movedRange() {
				...
				return new oa(this.sourcePosition, e)
			}
			clone() {
			...
			getReversed() {
				const e = this.targetPosition._getTransformedByMergeOperation(this),
					...
					i = new ea(this.sourcePosition.root, t)._getTransformedByMergeOperation(this);
				return new Rc(e, this.howMany, i, this.graveyardPosition, this.baseVersion + 1)
			}
			_validate() {
				const e = this.sourcePosition.parent,
					t = this.targetPosition.parent;
			...
			_execute() {
				const e = this.sourcePosition.parent;
				kc(oa._createIn(e), this.targetPosition), kc(oa._createOn(e), this.graveyardPosition)
			}
			toJSON() {
				const e = super.toJSON();
			...
			static fromJSON(e, t) {
				const i = ea.fromJSON(e.sourcePosition, t),
					n = ea.fromJSON(e.targetPosition, t),
					o = ea.fromJSON(e.graveyardPosition, t);
		...
		class Rc extends mc {
			...
			get moveTargetPosition() {
				...
				return e.push(0), new ea(this.insertionPosition.root, e)
			}
			get movedRange() {
				const e = this.splitPosition.getShiftedBy(Number.POSITIVE_INFINITY);
				return new oa(this.splitPosition, e)
			}
			clone() {
			...
			getReversed() {
				const e = this.splitPosition.root.document.graveyard,
					t = new ea(e, [0]);
				return new Nc(this.moveTargetPosition, this.howMany, this.splitPosition, t, this.baseVersion + 1)
			}
			_validate() {
			...
			_execute() {
				...
				if (this.graveyardPosition) kc(oa._createFromPositionAndShift(this.graveyardPosition, 1), this.insertionPosition);
					...
					const t = e._clone();
					bc(this.insertionPosition, t)
				}
				kc(new oa(ea._createAt(e, this.splitPosition.offset), ea._createAt(e, e.maxOffset)), this.moveTargetPosition)
			}
			toJSON() {
				const e = super.toJSON();
			...
			static getInsertionPosition(e) {
				...
				return t[t.length - 1]++, new ea(e.root, t, "toPrevious")
			}
			static fromJSON(e, t) {
				const i = ea.fromJSON(e.splitPosition, t),
					n = ea.fromJSON(e.insertionPosition, t),
					o = e.graveyardPosition ? ea.fromJSON(e.graveyardPosition, t) : null;
				return new this(i, e.howMany, n, o, e.baseVersion)
			}
		}
		class Oc extends Js {
		...
		class Dc {
			...
			insert(e, t, i = 0) {
				...
				const n = ea._createAt(t, i);
				if (e.parent) {
					if (Bc(e.root, n.root)) return void this.move(oa._createOn(e), n);
				...
				const o = n.root.document ? n.root.document.version : null,
					r = new Pc(n, e, o);
				if (e instanceof Gs && (r.shouldReceiveAttributes = !0), this.batch.addOperation(r), this.model.applyOperation(r), e instanceof pc)
					for (const [t, i] of e.markers) {
						const e = ea._createAt(i.root, 0),
							o = {
								range: new oa(i.start._getCombined(e, n), i.end._getCombined(e, n)),
								usingOperation: !0,
								affectsData: !0
							};
			...
			setAttribute(e, t, i) {
				if (this._assertWriterUsedCorrectly(), i instanceof oa) {
					...
					for (const i of n) Lc(this, e, t, i)
				} else zc(this, e, t, i)
			}
			setAttributes(e, t) {
			...
			removeAttribute(e, t) {
				if (this._assertWriterUsedCorrectly(), t instanceof oa) {
					...
					for (const t of i) Lc(this, e, null, t)
				} else zc(this, e, null, t)
			}
			clearAttributes(e) {
			...
			move(e, t, i) {
				if (this._assertWriterUsedCorrectly(), !(e instanceof oa)) throw new c.a("writer-move-invalid-range", this);
				if (!e.isFlat) throw new c.a("writer-move-range-not-flat", this);
				const n = ea._createAt(t, i);
				if (n.isEqual(e.start)) return;
				if (this._addOperationForAffectedMarkers("move", e), !Bc(e.root, n.root)) throw new c.a("writer-move-different-document", this);
				const o = e.root.document ? e.root.document.version : null,
					r = new Ec(e.start, e.end.offset - e.start.offset, n, o);
				this.batch.addOperation(r), this.model.applyOperation(r)
			}
			remove(e) {
				this._assertWriterUsedCorrectly();
				const t = (e instanceof oa ? e : oa._createOn(e)).getMinimalFlatRanges().reverse();
				for (const e of t) this._addOperationForAffectedMarkers("move", e), jc(e.start, e.end.offset - e.start.offset, this.batch, this.model)
			}
			merge(e) {
				this._assertWriterUsedCorrectly();
				const t = e.nodeBefore,
					i = e.nodeAfter;
				if (this._addOperationForAffectedMarkers("merge", e), !(t instanceof Js)) throw new c.a("writer-merge-no-element-before", this);
				if (!(i instanceof Js)) throw new c.a("writer-merge-no-element-after", this);
			...
			_mergeDetached(e) {
				const t = e.nodeBefore,
					i = e.nodeAfter;
				this.move(oa._createIn(i), ea._createAt(t, "end")), this.remove(i)
			}
			_merge(e) {
				const t = ea._createAt(e.nodeBefore, "end"),
					i = ea._createAt(e.nodeAfter, 0),
					n = e.root.document.graveyard,
					o = new ea(n, [0]),
					r = e.root.document.version,
					s = new Nc(i, e.nodeAfter.maxOffset, t, o, r);
				this.batch.addOperation(s), this.model.applyOperation(s)
			}
			rename(e, t) {
				if (this._assertWriterUsedCorrectly(), !(e instanceof Js)) throw new c.a("writer-rename-not-element-instance", this);
				const i = e.root.document ? e.root.document.version : null,
					n = new Mc(ea._createBefore(e), e.name, t, i);
			...
			split(e, t) {
				...
				do {
					const t = o.root.document ? o.root.document.version : null,
						...
						s = Rc.getInsertionPosition(e),
						a = new Rc(e, r, s, null, t);
			...
			wrap(e, t) {
				...
				const n = new oa(e.start.getShiftedBy(1), e.end.getShiftedBy(1));
				this.move(n, ea._createAt(i, 0))
			}
			unwrap(e) {
			...
			addMarker(e, t) {
				...
				return i ? (Vc(this, e, null, n, o), this.model.markers.get(e)) : this.model.markers._set(e, n, i, o)
			}
			updateMarker(e, t) {
				this._assertWriterUsedCorrectly();
				...
				const a = n.getRange(),
					l = t.range ? t.range : a;
				o && t.usingOperation !== n.managedUsingOperations ? t.usingOperation ? Vc(this, i, null, l, s) : (Vc(this, i, a, null, s), this.model.markers._set(i, l, void 0, s)) : n.managedUsingOperations ? Vc(this, i, a, l, s) : this.model.markers._set(i, l, void 0, s)
			}
			removeMarker(e) {
				this._assertWriterUsedCorrectly();
				...
				Vc(this, t, i.getRange(), null, i.affectsData)
			}
			setSelection(e, t, i) {
			...
			_setSelectionAttribute(e, t) {
				...
				if (i.isCollapsed && i.anchor.parent.isEmpty) {
					const n = _a._getStoreAttributeKey(e);
			...
			_removeSelectionAttribute(e) {
				...
				if (t.isCollapsed && t.anchor.parent.isEmpty) {
					const i = _a._getStoreAttributeKey(e);
		...
		function zc(e, t, i, n) {
			...
			if (s != i) {
				if (n.root === n) {
					...
					a = new oa(ea._createBefore(n), e.createPositionAfter(n));
		...
		function Vc(e, t, i, n, o) {
			const r = e.model,
				s = r.document,
				a = new Sc(t, i, n, r.markers, o, s.version);
		...
		function jc(e, t, i, n) {
			...
			if (e.root.document) {
				const i = n.document,
					r = new ea(i.graveyard, [0]);
				o = new Ec(e, t, r, i.version)
			} else o = new Tc(e, t);
			i.addOperation(o), n.applyOperation(o)
		}

		function Bc(e, t) {
			return e === t || e instanceof Oc && t instanceof Oc
		}
		class Fc {
			constructor(e) {
			...
			bufferOperation(e) {
				switch (e.type) {
					...
					case "rename": {
						...
						const t = oa._createFromPositionAndShift(e.position, 1);
						for (const e of this._markerCollection.getMarkersIntersectingRange(t)) {
							const t = e.getRange();
							this.bufferMarkerChange(e.name, t, t, e.affectsData)
						}
			...
			getChanges(e = {
				...
				for (const e of this._changesInElement.keys()) {
					...
					for (const i of r)
						...
						const i = o[s].attributes,
							r = n[a].attributes;
						let c;
						if ("$text" == o[s].name) c = new oa(ea._createAt(e, s), ea._createAt(e, s + 1));
						else {
							const t = e.offsetToIndex(s);
							c = new oa(ea._createAt(e, s), ea._createAt(e.getChild(t), 0))
						}
				...
				return this._changeCount = 0, this._cachedChangesWithGraveyard = t.slice(), this._cachedChanges = t.filter(Wc), e.includeChangesInGraveyard ? this._cachedChangesWithGraveyard : this._cachedChanges
			}
			reset() {
			...
			_removeAllNestedChanges(e, t, i) {
				const n = new oa(ea._createAt(e, t), ea._createAt(e, t + i));
		...
		class Gc {
			constructor(e) {
				this.model = e, this.version = 0, this.history = new qc(this), this.selection = new _a(this), this.roots = new Zi({
					idProperty: "rootName"
				}), this.differ = new Fc(e.markers), this._postFixers = new Set, this._hasSelectionChangedFromTheLastChangeBlock = !1, this.createRoot("$root", "$graveyard"), this.listenTo(e, "applyOperation", (e, t) => {
					const i = t[0];
		...
		class Qc {
			...
			_set(e, t, i = !1, n = !1) {
				const o = e instanceof Jc ? e.name : e;
				if (o.includes(",")) throw new c.a("markercollection-incorrect-marker-name", this);
				const r = this._markers.get(o);
				if (r) {
					const e = r.getRange();
					let s = !1;
					return e.isEqual(t) || (r._attachLiveRange(ba.fromRange(t)), s = !0), i != r.managedUsingOperations && (r._managedUsingOperations = i, s = !0), "boolean" == typeof n && n != r.affectsData && (r._affectsData = n, s = !0), s && this.fire("update:" + o, r, e, t), r
				}
				const s = ba.fromRange(t),
					a = new Jc(o, s, i, n);
				return this._markers.set(o, a), this.fire("update:" + o, a, null, t), a
			}
			_remove(e) {
				const t = e instanceof Jc ? e.name : e,
		...
		const Xc = {};
		Xc[Cc.className] = Cc, Xc[Pc.className] = Pc, Xc[Sc.className] = Sc, Xc[Ec.className] = Ec, Xc[Zc.className] = Zc, Xc[mc.className] = mc, Xc[Mc.className] = Mc, Xc[Ic.className] = Ic, Xc[Rc.className] = Rc, Xc[Nc.className] = Nc;
		class el extends ea {
			constructor(e, t, i = "toNone") {
		...
		function tl() {
			this.listenTo(this.root.document.model, "applyOperation", (e, t) => {
				const i = t[0];
				i.isDocumentOperation && il.call(this, i)
			}, {
				priority: "low"
			})
		}
		...
		class nl {
			...
			_insertPartialFragment() {
				...
				const e = el.fromPosition(this.position, "toNext");
			...
			_mergeOnLeft() {
				...
				if (!(e instanceof Js)) return;
				if (!this._canMergeLeft(e)) return;
				const t = el._createBefore(e);
				t.stickiness = "toNext";
				const i = el.fromPosition(this.position, "toNext");
				this._affectedStart.isEqual(t) && (this._affectedStart.detach(), this._affectedStart = el._createAt(t.nodeBefore, "end", "toPrevious")), this._firstNode === this._lastNode && (this._firstNode = t.nodeBefore, this._lastNode = t.nodeBefore), this.writer.merge(t), t.isEqual(this._affectedEnd) && this._firstNode === this._lastNode && (this._affectedEnd.detach(), this._affectedEnd = el._createAt(t.nodeBefore, "end", "toNext")), this.position = i.toPosition(), i.detach(), this._filterAttributesOf.push(this.position.parent), t.detach()
			}
			_mergeOnRight() {
				const e = this._lastNode;
				if (!(e instanceof Js)) return;
				if (!this._canMergeRight(e)) return;
				const t = el._createAfter(e);
				if (t.stickiness = "toNext", !this.position.isEqual(t)) throw new c.a("insertcontent-invalid-insertion-position", this);
				this.position = ea._createAt(t.nodeBefore, "end");
				const i = el.fromPosition(this.position, "toPrevious");
				this._affectedEnd.isEqual(t) && (this._affectedEnd.detach(), this._affectedEnd = el._createAt(t.nodeBefore, "end", "toNext")), this._firstNode === this._lastNode && (this._firstNode = t.nodeBefore, this._lastNode = t.nodeBefore), this.writer.merge(t), t.getShiftedBy(-1).isEqual(this._affectedStart) && this._firstNode === this._lastNode && (this._affectedStart.detach(), this._affectedStart = el._createAt(t.nodeBefore, 0, "toPrevious")), this.position = i.toPosition(), i.detach(), this._filterAttributesOf.push(this.position.parent), t.detach()
			}
			_canMergeLeft(e) {
				const t = e.previousSibling;
				return t instanceof Js && this.canMergeWith.has(t) && this.model.schema.checkMerge(t, e)
			}
			_canMergeRight(e) {
				const t = e.nextSibling;
				return t instanceof Js && this.canMergeWith.has(t) && this.model.schema.checkMerge(e, t)
			}
		...
		function ol(e, t, i = {}) {
			...
			e.change(e => {
				...
				function(e, t) {
					...
					e.remove(e.createRangeIn(i)), sl(e, e.createPositionAt(i, 0), t)
				}(e, t);
				const [r, s] = function(e) {
					...
					return [el.fromPosition(i, "toPrevious"), el.fromPosition(n, "toNext")]
				}(n);
				r.isTouching(s) || e.remove(e.createRange(r, s)), i.leaveUnmerged || (! function(e, t, i) {
					const n = e.model;
					if (!rl(e.model.schema, t, i)) return;
					...
					!n.hasContent(o, {
						...
						if (n = t.createPositionBefore(s), function(e, t) {
							...
							}(t, n), !rl(t.model.schema, i, n)) return;
						e(t, i, n, o)
						...
						if (!rl(t.model.schema, i, n)) return;
						e(t, i, n, o)
					}(e, t, i, o.parent)
				}(e, r, s), o.removeDisallowedAttributes(r.parent.getChildren(), e)), al(e, t, r), !i.doNotAutoparagraph && function(e, t) {
					const i = e.checkChild(t, "$text"),
						n = e.checkChild(t, "paragraph");
					return !i && n
				}(o, r) && sl(e, r, t), r.detach(), s.detach()
			})
		}
		...
		function sl(e, t, i) {
			...
			e.insert(n, t), al(e, i, e.createPositionAt(n, 0))
		}

		function al(e, t, i) {
			t instanceof _a ? e.setSelection(i) : t.setTo(i)
		}
		...
		function cl(e, t) {
			...
			if ("text" == s) return "word" === e.unit ? function(e, t) {
				...
				if (i) {
					...
					for (; $c(n, o) || "character" == t && Yc(n, o);) e.next(), o = e.position.offset - i.startOffset
				}
				return e.position
			}(n, o);
			if (s == (i ? "elementStart" : "elementEnd")) {
				if (r.isSelectable(a)) return ea._createAt(a, i ? "after" : "before");
		...
		function ll(e, t) {
			const i = e.root,
				n = ea._createAt(i, t ? "end" : 0);
			return t ? new oa(e, n) : new oa(n, e)
		}
			...
			return e.isCollapsed ? function(e, t) {
				...
				if (c || l) {
					const e = i.nodeAfter && n.nodeBefore && i.nodeAfter.parent === n.nodeBefore.parent,
						o = c && (!e || !pl(i.nodeAfter, t)),
						r = l && (!e || !pl(n.nodeBefore, t));
					let d = i,
						u = n;
					return o && (d = ea._createBefore(ml(s, t))), r && (u = ea._createAfter(ml(a, t))), new oa(d, u)
				}
				return null
			}(e, t)
		}
		...
		class bl {
			constructor() {
				this.markers = new Qc, this.document = new Gc(this), this.schema = new $a, this._pendingChanges = [], this._currentWriter = null, ["insertContent", "deleteContent", "modifySelection", "getSelectedContent", "applyOperation"].forEach(e => this.decorate(e)), this.on("applyOperation", (e, t) => {
					t[0]._validate()
				}, {
					priority: "highest"
				...
				}), fl(this), this.document.registerPostFixer(Na)
			}
			change(e) {
				try {
			...
			enqueueChange(e, t) {
				try {
					"string" == typeof e ? e = new gc(e) : "function" == typeof e && (t = e, e = new gc), this._pendingChanges.push({
						batch: e,
						callback: t
			...
			insertContent(e, t, i) {
				return function(e, t, i, n) {
					return e.change(o => {
						let r;
						r = i ? i instanceof ha || i instanceof _a ? i : o.createSelection(i, n) : e.document.selection, r.isCollapsed || e.deleteContent(r, {
							doNotAutoparagraph: !0
						});
						const s = new nl(e, o, r.anchor);
						let a;
						a = t.is("documentFragment") ? t.getChildren() : [t], s.handleNodes(a);
						const c = s.getSelectionRange();
						c && (r instanceof _a ? o.setSelection(c) : r.setTo(c));
			...
			modifySelection(e, t) {
				! function(e, t, i = {}) {
					...
					for (; l = a.next();) {
						if (l.done) return;
						const i = cl(c, l.value);
						if (i) return void(t instanceof _a ? e.change(e => {
				...
				return function(e, t) {
					return e.change(e => {
						...
						if (a != n) {
							...
							hl(e.createRange(t.end, e.createPositionAt(i, "end")), e), hl(o, e)
						}
						return i
					})
				}(this, e)
			...
			hasContent(e, t = {}) {
				const i = e instanceof Js ? oa._createIn(e) : e;
			...
			_runPendingChanges() {
				...
				for (this.fire("_beforeChanges"); this._pendingChanges.length;) {
					...
					this._currentWriter = new Dc(this, t);
		...
		class kl {
			constructor(e = {}) {
				...
				const i = new Qn;
				this.data = new dc(this.model, i), this.editing = new Ha(this.model, i), this.editing.view.document.bind("isReadOnly").to(this), this.conversion = new uc([this.editing.downcastDispatcher, this.data.downcastDispatcher], this.data.upcastDispatcher), this.conversion.addAlias("dataDowncast", this.data.downcastDispatcher), this.conversion.addAlias("editingDowncast", this.editing.downcastDispatcher), this.keystrokes = new wl(this), this.keystrokes.listenTo(this.editing.view.document)
			}
			initPlugins() {
				const e = this.config,
					t = e.get("plugins"),
		...
		class yl {
			constructor(e) {
				this.editor = e, this.componentFactory = new _l(e), this.focusTracker = new Rs, this._editableElementsMap = new Map, this.listenTo(e.editing.view.document, "layoutChanged", () => this.update())
			}
			get element() {
				return null
			}
		...
		const Tl = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="m11.591 10.177 4.243 4.242a1 1 0 0 1-1.415 1.415l-4.242-4.243-4.243 4.243a1 1 0 0 1-1.414-1.415l4.243-4.242L4.52 5.934A1 1 0 0 1 5.934 4.52l4.243 4.243 4.242-4.243a1 1 0 1 1 1.415 1.414l-4.243 4.243z"/></svg>',
			El = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M6.972 16.615a.997.997 0 0 1-.744-.292l-4.596-4.596a1 1 0 1 1 1.414-1.414l3.926 3.926 9.937-9.937a1 1 0 0 1 1.414 1.415L7.717 16.323a.997.997 0 0 1-.745.292z"/></svg>',
			Pl = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M5.085 6.22 2.943 4.078a.75.75 0 1 1 1.06-1.06l2.592 2.59A11.094 11.094 0 0 1 10 5.068c4.738 0 8.578 3.101 8.578 5.083 0 1.197-1.401 2.803-3.555 3.887l1.714 1.713a.75.75 0 0 1-.09 1.138.488.488 0 0 1-.15.084.75.75 0 0 1-.821-.16L6.17 7.304c-.258.11-.51.233-.757.365l6.239 6.24-.006.005.78.78c-.388.094-.78.166-1.174.215l-1.11-1.11h.011L4.55 8.197a7.2 7.2 0 0 0-.665.514l-.112.098 4.897 4.897-.005.006 1.276 1.276a10.164 10.164 0 0 1-1.477-.117l-.479-.479-.009.009-4.863-4.863-.022.031a2.563 2.563 0 0 0-.124.2c-.043.077-.08.158-.108.241a.534.534 0 0 0-.028.133.29.29 0 0 0 .008.072.927.927 0 0 0 .082.226c.067.133.145.26.234.379l3.242 3.365.025.01.59.623c-3.265-.918-5.59-3.155-5.59-4.668 0-1.194 1.448-2.838 3.663-3.93zm7.07.531a4.632 4.632 0 0 1 1.108 5.992l.345.344.046-.018a9.313 9.313 0 0 0 2-1.112c.256-.187.5-.392.727-.613.137-.134.27-.277.392-.431.072-.091.141-.185.203-.286.057-.093.107-.19.148-.292a.72.72 0 0 0 .036-.12.29.29 0 0 0 .008-.072.492.492 0 0 0-.028-.133.999.999 0 0 0-.036-.096 2.165 2.165 0 0 0-.071-.145 2.917 2.917 0 0 0-.125-.2 3.592 3.592 0 0 0-.263-.335 5.444 5.444 0 0 0-.53-.523 7.955 7.955 0 0 0-1.054-.768 9.766 9.766 0 0 0-1.879-.891c-.337-.118-.68-.219-1.027-.301zm-2.85.21-.069.002a.508.508 0 0 0-.254.097.496.496 0 0 0-.104.679.498.498 0 0 0 .326.199l.045.005c.091.003.181.003.272.012a2.45 2.45 0 0 1 2.017 1.513c.024.061.043.125.069.185a.494.494 0 0 0 .45.287h.008a.496.496 0 0 0 .35-.158.482.482 0 0 0 .13-.335.638.638 0 0 0-.048-.219 3.379 3.379 0 0 0-.36-.723 3.438 3.438 0 0 0-2.791-1.543l-.028-.001h-.013z"/></svg>',
			Sl = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M6.91 10.54c.26-.23.64-.21.88.03l3.36 3.14 2.23-2.06a.64.64 0 0 1 .87 0l2.52 2.97V4.5H3.2v10.12l3.71-4.08zm10.27-7.51c.6 0 1.09.47 1.09 1.05v11.84c0 .59-.49 1.06-1.09 1.06H2.79c-.6 0-1.09-.47-1.09-1.06V4.08c0-.58.49-1.05 1.1-1.05h14.38zm-5.22 5.56a1.96 1.96 0 1 1 3.4-1.96 1.96 1.96 0 0 1-3.4 1.96z"/></svg>',
			Ml = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414"><path d="M18 4.5V3H2v1.5h16zm0 3V6h-5.674v1.5H18zm0 3V9h-5.674v1.5H18zm0 3V12h-5.674v1.5H18zm-8.5-6V12h-6V7.5h6zm.818-1.5H2.682C2.305 6 2 6.407 2 6.91v5.68c0 .503.305.91.682.91h7.636c.377 0 .682-.407.682-.91V6.91c0-.503-.305-.91-.682-.91zM18 16.5V15H2v1.5h16z"/></svg>',
			Il = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 4.5V3h16v1.5zm4.5 3V12h7V7.5h-7zM5.758 6h8.484c.419 0 .758.407.758.91v5.681c0 .502-.34.909-.758.909H5.758c-.419 0-.758-.407-.758-.91V6.91c0-.503.34-.91.758-.91zM2 16.5V15h16v1.5z"/></svg>',
			Nl = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 4.5V3h16v1.5zm0 3V6h5.674v1.5zm0 3V9h5.674v1.5zm0 3V12h5.674v1.5zm8.5-6V12h6V7.5h-6zM9.682 6h7.636c.377 0 .682.407.682.91v5.68c0 .503-.305.91-.682.91H9.682c-.377 0-.682-.407-.682-.91V6.91c0-.503.305-.91.682-.91zM2 16.5V15h16v1.5z"/></svg>',
			Rl = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 4.5V3h16v1.5zm2.5 3V12h11V7.5h-11zM4.061 6H15.94c.586 0 1.061.407 1.061.91v5.68c0 .503-.475.91-1.061.91H4.06c-.585 0-1.06-.407-1.06-.91V6.91C3 6.406 3.475 6 4.061 6zM2 16.5V15h16v1.5z"/></svg>',
			Ol = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="m7.3 17.37-.061.088a1.518 1.518 0 0 1-.934.535l-4.178.663-.806-4.153a1.495 1.495 0 0 1 .187-1.058l.056-.086L8.77 2.639c.958-1.351 2.803-1.076 4.296-.03 1.497 1.047 2.387 2.693 1.433 4.055L7.3 17.37zM9.14 4.728l-5.545 8.346 3.277 2.294 5.544-8.346L9.14 4.728zM6.07 16.512l-3.276-2.295.53 2.73 2.746-.435zM9.994 3.506 13.271 5.8c.316-.452-.16-1.333-1.065-1.966-.905-.634-1.895-.78-2.212-.328zM8 18.5 9.375 17H19v1.5H8z"/></svg>',
			Dl = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M3 10.423a6.5 6.5 0 0 1 6.056-6.408l.038.67C6.448 5.423 5.354 7.663 5.22 10H9c.552 0 .5.432.5.986v4.511c0 .554-.448.503-1 .503h-5c-.552 0-.5-.449-.5-1.003v-4.574zm8 0a6.5 6.5 0 0 1 6.056-6.408l.038.67c-2.646.739-3.74 2.979-3.873 5.315H17c.552 0 .5.432.5.986v4.511c0 .554-.448.503-1 .503h-5c-.552 0-.5-.449-.5-1.003v-4.574z"/></svg>',
			Ll = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><circle cx="9.5" cy="4.5" r="1.5"/><circle cx="9.5" cy="10.5" r="1.5"/><circle cx="9.5" cy="16.5" r="1.5"/></svg>';
		...
		class Fl {
			...
			get bindTemplate() {
				return this._bindTemplate ? this._bindTemplate : this._bindTemplate = Hl.bind(this, this)
			}
			createCollection(e) {
				const t = new Bl(e);
			...
			setTemplate(e) {
				this.template = new Hl(e)
			}
			extendTemplate(e) {
				Hl.extend(this.template, e)
			}
			render() {
		...
		class Hl {
			constructor(e) {
				Object.assign(this, Zl(Jl(e))), this._isRendered = !1, this._revertData = null
			}
			render() {
			...
			revert(e) {
				...
				yield* function* e(t) {
					if (t.children)
						for (const i of t.children) nd(i) ? yield i: od(i) && (yield* e(i))
				}(this)
			}
			static bind(e, t) {
				return {
			...
			static extend(e, t) {
				...
				! function e(t, i) {
					i.attributes && (t.attributes || (t.attributes = {}), td(t.attributes, i.attributes));
					i.eventListeners && (t.eventListeners || (t.eventListeners = {}), td(t.eventListeners, i.eventListeners));
			...
			_renderText(e) {
				let t = e.node;
				return t ? e.revertData.text = t.textContent : t = e.node = document.createTextNode(""), $l(this.text) ? this._bindToObservable({
					schema: this.text,
					updater: Gl(t),
					data: e
			...
			_renderAttributes(e) {
				...
				for (t in this.attributes)
					if (n = r.getAttribute(t), i = this.attributes[t], s && (s.attributes[t] = n), o = w(i[0]) && i[0].ns ? i[0].ns : null, $l(i)) {
						const a = o ? i[0].value : i;
						s && sd(t) && a.unshift(n), this._bindToObservable({
							schema: a,
							updater: Kl(r, t, o),
							data: e
						})
					} else "style" == t && "string" != typeof i[0] ? this._renderStyleAttribute(i[0], e) : (s && n && sd(t) && i.unshift(n), i = i.map(e => e && e.value || e).reduce((e, t) => e.concat(t), []).reduce(ed, ""), id(i) || r.setAttributeNS(o, t, i))
			}
			_renderStyleAttribute(e, t) {
				const i = t.node;
				for (const n in e) {
					const o = e[n];
					$l(o) ? this._bindToObservable({
						schema: [o],
						updater: Ql(i, n),
						data: t
					}) : i.style[n] = o
			...
			_renderElementChildren(e) {
				...
				for (const r of this.children)
					...
					} else if (nd(r)) n || (r.isRendered || r.render(), i.appendChild(r.element));
				else if (mr(r)) i.appendChild(r);
				else if (n) {
					const t = {
						children: [],
						bindings: [],
			...
			_bindToObservable({
				...
				Yl(e, t, i);
				const o = e.filter(e => !id(e)).filter(e => e.observable).map(n => n.activateAttributeListener(e, t, i));
				n && n.bindings.push(o)
			}
		...
		class ql extends Ul {
			getValue(e) {
				return !id(super.getValue(e)) && (this.valueIfTrue || !0)
			}
		}

		function $l(e) {
			return !!e && (e.value && (e = e.value), Array.isArray(e) ? e.some($l) : e instanceof Ul)
		}
		...
		function Yl(e, t, {
			...
			let n = function(e, t) {
				return e.map(e => e instanceof Ul ? e.getValue(t) : e)
			}(e, i);
			n = 1 == e.length && e[0] instanceof ql ? n[0] : n.reduce(ed, ""), id(n) ? t.remove() : t.set(n)
		}
		...
		function Jl(e) {
			return $i(e, e => {
				if (e && (e instanceof Ul || od(e) || nd(e) || rd(e))) return e
			})
		}
		...
		function Zl(e) {
			if ("string" == typeof e ? e = function(e) {
					...
					for (const t in e) Xl(e, t);
					return e
				}(e.on), delete e.on), !e.text) {
				e.attributes && function(e) {
					for (const t in e) e[t].value && (e[t].value = en(e[t].value)), Xl(e, t)
				}(e.attributes);
				const t = [];
				if (e.children)
					if (rd(e.children)) t.push(e.children);
					else
						for (const i of e.children) od(i) || nd(i) || mr(i) ? t.push(i) : t.push(new Hl(i));
				e.children = t
			}
			return e
		}
		...
		class ad extends Bl {
			...
			attachToDom() {
				this._bodyCollectionContainer = new Hl({
					tag: "div",
					attributes: {
				...
				e || (e = function(e, t, i = {}, n = []) {
					...
					!ys(n) && Ji(n) || (n = [n]);
					for (let t of n) ys(t) && (t = e.createTextNode(t)), r.appendChild(t);
					return r
				}(document, "div", {
		...
		class hd {
			...
			get first() {
				return this.focusables.find(fd) || null
			}
			get last() {
				return this.focusables.filter(fd).slice(-1)[0] || null
			}
			get next() {
		...
		function fd(e) {
			return !(!e.focus || "none" == _r.window.getComputedStyle(e.element).display)
		}
		i(24);
		var gd = '<svg viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg"><path d="M.941 4.523a.75.75 0 1 1 1.06-1.06l3.006 3.005 3.005-3.005a.75.75 0 1 1 1.06 1.06l-3.549 3.55a.75.75 0 0 1-1.168-.136L.941 4.523z"/></svg>';
		class md extends dd {
			constructor(e) {
			...
			_createArrowView() {
				const e = new cd;
				return e.content = gd, e.extendTemplate({
					attributes: {
		...
		class pd extends Fl {
			...
			_createArrowView() {
				const e = new dd,
					t = e.bindTemplate;
				return e.icon = gd, e.extendTemplate({
					attributes: {
		...
		function wd({
			...
			I(t) && (t = t()), I(n) && (n = n());
			const r = function(e) {
					return e && e.parentNode ? e.offsetParent === _r.document.body ? null : e.offsetParent : null
				}(e),
				s = new Ts(e),
				a = new Ts(t);
			let c, l;
			if (n || o) {
				const e = function(e, t) {
					...
					targetRect: a,
					elementRect: s,
					limiterRect: n && new Ts(n).getVisible(),
					viewportRect: o && new Ts(_r.window)
				});
				[l, c] = e || kd(i[0], a, s)
			} else [l, c] = kd(i[0], a, s);
			let d = vd(c);
		...
		class yd extends Fl {
			constructor(e, t, i) {
				...
				this.buttonView = t, this.panelView = i, this.set("isOpen", !1), this.set("isEnabled", !0), this.set("class"), this.set("id"), this.set("panelPosition", "auto"), this.keystrokes = new Os, this.setTemplate({
					tag: "div",
					attributes: {
			...
			render() {
				super.render(), this.listenTo(this.buttonView, "open", () => {
					...
					this.isOpen && ("auto" === this.panelPosition ? this.panelView.position = yd._getOptimalPosition({
		...
		class Td extends Fl {
			constructor(e, t) {
				...
				const r = ["ck", "ck-toolbar", i.to("class"), i.if("isCompact", "ck-toolbar_compact")];
				var s;
				this.options.shouldGroupWhenFull && this.options.isFloating && r.push("ck-toolbar_floating"), this.setTemplate({
					...
					children: this.children,
					on: {
						mousedown: (s = this, s.bindTemplate.to(e => {
							e.target === s.element && e.preventDefault()
						}))
					}
				}), this._behavior = this.options.shouldGroupWhenFull ? new Sd(this) : new Pd(this)
			}
			render() {
				super.render();
			...
			fillFromConfig(e, t) {
				const i = Cd(e),
					...
					o = this._cleanSeparators(n).map(e => "|" === e ? new xd : "-" === e ? new Ad : t.create(e));
		...
		class Sd {
			...
			get _areItemsOverflowing() {
				...
				const e = this.viewElement,
					...
					i = new Ts(e.lastChild),
					n = new Ts(e);
				if (!this.cachedPadding) {
					const i = _r.window.getComputedStyle(e),
			...
			_enableGroupingOnResize() {
				let e;
				this.resizeObserver = new Ss(this.viewElement, t => {
			...
			_groupLastItem() {
				this.groupedItems.length || (this.viewChildren.add(new xd), this.viewChildren.add(this.groupedItemsDropdown), this.viewFocusTracker.add(this.groupedItemsDropdown.element)), this.groupedItems.add(this.ungroupedItems.remove(this.ungroupedItems.last), 0)
			}
			_ungroupFirstItem() {
		...
		class Md extends Fl {
			constructor() {
				super(), this.items = this.createCollection(), this.focusTracker = new Rs, this.keystrokes = new Os, this._focusCycler = new hd({
		...
		function Rd(e, t = md) {
			const i = new t(e),
				n = new bd(e),
				o = new yd(e, i, n);
			return i.bind("isEnabled").to(o), i instanceof md ? i.bind("isOn").to(o, "isOpen") : i.arrowView.bind("isOn").to(o, "isOpen"),
				function(e) {
					(function(e) {
						e.on("render", () => {
							zl({
					...
					function(e) {
						e.on("execute", t => {
							t.source instanceof ud || (e.isOpen = !1)
						})
					}(e),
					function(e) {
		...
		function Od(e, t) {
			const i = e.locale,
				n = e.listView = new Md(i);
			n.items.bindTo(t).using(({
				type: e,
				model: t
			}) => {
				if ("separator" === e) return new Nd(i);
				if ("button" === e || "switchbutton" === e) {
					const n = new Id(i);
					let o;
					return o = "button" === e ? new dd(i) : new ud(i), o.bind(...Object.keys(t)).to(t), o.delegate("execute").to(n), n.children.add(o), n
				}
		...
		class Bd extends Fl {
			constructor(e) {
				super(e), this.set("value"), this.set("id"), this.set("placeholder"), this.set("isReadOnly", !1), this.set("hasError", !1), this.set("ariaDescribedById"), this.focusTracker = new Rs, this.bind("isFocused").to(this.focusTracker), this.set("isEmpty", !0);
				const t = this.bindTemplate;
				this.setTemplate({
					tag: "input",
					attributes: {
		...
		class Yd extends Fl {
			...
			_startPinning(e) {
				this.attachTo(e);
				const t = Gd(e.target),
					i = e.limiter ? Gd(e.limiter) : $d;
				this.listenTo(_r.document, "scroll", (n, o) => {
					const r = o.target,
						s = t && r.contains(t),
						a = i && r.contains(i);
		...
		function Gd(e) {
			return Yi(e) ? e : xs(e) ? e.commonAncestorContainer : "function" == typeof e ? Gd(e()) : null
		}

		function Kd(e, t) {
			return e.top - t.height - Yd.arrowVerticalOffset
		}

		function Qd(e) {
			return e.bottom + Yd.arrowVerticalOffset
		}
		Yd.arrowHorizontalOffset = 25, Yd.arrowVerticalOffset = 10, Yd._getOptimalPosition = wd, Yd.defaultPositions = {
			northWestArrowSouthWest: (e, t) => ({
				top: Kd(e, t),
				left: e.left - Yd.arrowHorizontalOffset,
				name: "arrow_sw"
			}),
			northWestArrowSouthMiddleWest: (e, t) => ({
				top: Kd(e, t),
				left: e.left - .25 * t.width - Yd.arrowHorizontalOffset,
				name: "arrow_smw"
			}),
			...
			northWestArrowSouthMiddleEast: (e, t) => ({
				top: Kd(e, t),
				left: e.left - .75 * t.width + Yd.arrowHorizontalOffset,
				name: "arrow_sme"
			}),
			northWestArrowSouthEast: (e, t) => ({
				top: Kd(e, t),
				left: e.left - t.width + Yd.arrowHorizontalOffset,
				name: "arrow_se"
			}),
			northArrowSouthWest: (e, t) => ({
				top: Kd(e, t),
				left: e.left + e.width / 2 - Yd.arrowHorizontalOffset,
				name: "arrow_sw"
			}),
			northArrowSouthMiddleWest: (e, t) => ({
				top: Kd(e, t),
				left: e.left + e.width / 2 - .25 * t.width - Yd.arrowHorizontalOffset,
				name: "arrow_smw"
			}),
			northArrowSouth: (e, t) => ({
				top: Kd(e, t),
			...
			northArrowSouthMiddleEast: (e, t) => ({
				top: Kd(e, t),
				left: e.left + e.width / 2 - .75 * t.width + Yd.arrowHorizontalOffset,
				name: "arrow_sme"
			}),
			northArrowSouthEast: (e, t) => ({
				top: Kd(e, t),
				left: e.left + e.width / 2 - t.width + Yd.arrowHorizontalOffset,
				name: "arrow_se"
			}),
			northEastArrowSouthWest: (e, t) => ({
				top: Kd(e, t),
				left: e.right - Yd.arrowHorizontalOffset,
				name: "arrow_sw"
			}),
			northEastArrowSouthMiddleWest: (e, t) => ({
				top: Kd(e, t),
				left: e.right - .25 * t.width - Yd.arrowHorizontalOffset,
				name: "arrow_smw"
			}),
			...
			northEastArrowSouthMiddleEast: (e, t) => ({
				top: Kd(e, t),
				left: e.right - .75 * t.width + Yd.arrowHorizontalOffset,
				name: "arrow_sme"
			}),
			northEastArrowSouthEast: (e, t) => ({
				top: Kd(e, t),
				left: e.right - t.width + Yd.arrowHorizontalOffset,
				name: "arrow_se"
			}),
		...
		class Zd extends Qe {
			...
			_createRotatorView() {
				const e = new Xd(this.editor.locale),
			...
			_createFakePanelsView() {
				const e = new eu(this.editor.locale, this.view);
			...
			updatePosition() {
				if (this.numberOfPanels) {
					const {
						...
						width: i,
						height: n
					} = new Ts(this._balloonPanelView.element);
					Object.assign(this, {
						top: e,
						left: t,
						width: i,
		...
		class iu extends Fl {
			constructor(e) {
				super(e);
				const t = this.bindTemplate;
				this.set("isActive", !1), this.set("isSticky", !1), this.set("limiterElement", null), this.set("limiterBottomOffset", 50), this.set("viewportTopOffset", 0), this.set("_marginLeft", null), this.set("_isStickyToTheLimiter", !1), this.set("_hasViewportTopOffset", !1), this.content = this.createCollection(), this._contentPanelPlaceholder = new Hl({
					tag: "div",
					attributes: {
						class: ["ck", "ck-sticky-panel__placeholder"],
						style: {
							display: t.to("isSticky", e => e ? "block" : "none"),
							height: t.to("isSticky", e => e ? tu(this._panelRect.height) : null)
						}
					}
				}).render(), this._contentPanel = new Hl({
					tag: "div",
					attributes: {
						...
						style: {
							width: t.to("isSticky", e => e ? tu(this._contentPanelPlaceholder.getBoundingClientRect().width) : null),
							top: t.to("_hasViewportTopOffset", e => e ? tu(this.viewportTopOffset) : null),
							bottom: t.to("_isStickyToTheLimiter", e => e ? tu(this.limiterBottomOffset) : null),
		...
		function ou(e) {
			...
			nu.has(s) || (nu.set(s, new Map), s.registerPostFixer(e => su(s, e))), nu.get(s).set(i, {
				text: n,
				isDirectHost: o,
				keepOnFocus: r,
		...
		function su(e, t) {
			const i = nu.get(e),
				n = [];
			let o = !1;
			for (const [e, r] of i) r.isDirectHost && (n.push(e), au(t, e, r) && (o = !0));
			for (const [e, r] of i) {
				if (r.isDirectHost) continue;
				const i = cu(e);
				i && (n.includes(i) || (r.hostElement = i, au(t, e, r) && (o = !0)))
			}
			return o
		}
		...
		function du(e, t, i) {
			let n = lu.get(e);
			n || (n = new Map, lu.set(e, n)), n.set(t, i)
		}
		...
		function fu(e, t, i) {
			e = e.slice(), t = t.slice();
			const n = new gu(i.document, i.useRelations, i.forceWeakRemove);
			...
			for (; a < e.length;) {
				...
				const s = t[o],
					c = hu(i, s, n.getContext(i, s, !0)),
					l = hu(s, i, n.getContext(s, i, !1));
			...
			return mu(e, s.nextBaseVersionB), mu(t, s.nextBaseVersionA), {
				operationsA: e,
				operationsB: t,
				originalOperations: o
			}
			...
			updateRelation(e, t) {
				switch (e.constructor) {
						...
						switch (t.constructor) {
							...
							case Ec:
								if (e.splitPosition.isEqual(t.sourcePosition) || e.splitPosition.isBefore(t.sourcePosition)) this._setRelation(e, t, "splitBefore");
									...
									const i = oa._createFromPositionAndShift(t.sourcePosition, t.howMany);
					...
					case Sc: {
						...
						switch (t.constructor) {
							case Ec: {
								const n = oa._createFromPositionAndShift(t.sourcePosition, t.howMany),
		...
		function pu(e, t) {
			for (let i = 0; i < t; i++) e.push(new Zc(0))
		}

		function bu(e, t, i) {
			const n = e.nodes.getNode(0).getAttribute(t);
			if (n == i) return null;
			const o = new oa(e.position, e.position.getShiftedBy(e.howMany));
			return new Cc(o, t, n, i, 0)
		}
		...
		function ku(e, t) {
			...
			for (let n = 0; n < e.length; n++) {
				const o = e[n],
					r = new Ec(o.start, o.end.offset - o.start.offset, t, 0);
				i.push(r);
		...
		du(Cc, Cc, (e, t, i) => {
			if (e.key === t.key && e.range.start.hasSameParentAs(t.range.start)) {
				const n = e.range.getDifference(t.range).map(t => new Cc(t, e.key, e.oldValue, e.newValue, 0)),
					o = e.range.getIntersection(t.range);
				return o && i.aIsStrong && n.push(new Cc(o, t.key, t.newValue, e.newValue, 0)), 0 == n.length ? [new Zc(0)] : n
			}
			return [e]
		}), du(Cc, Pc, (e, t) => {
			if (e.range.start.hasSameParentAs(t.position) && e.range.containsPosition(t.position)) {
				const i = e.range._getTransformedByInsertion(t.position, t.howMany, !t.shouldReceiveAttributes).map(t => new Cc(t, e.key, e.oldValue, e.newValue, e.baseVersion));
				if (t.shouldReceiveAttributes) {
					const n = bu(t, e.key, e.oldValue);
					n && i.unshift(n)
				}
				return i
			}
			...
			const i = [];
			e.range.start.hasSameParentAs(t.deletionPosition) && (e.range.containsPosition(t.deletionPosition) || e.range.start.isEqual(t.deletionPosition)) && i.push(oa._createFromPositionAndShift(t.graveyardPosition, 1));
			const n = e.range._getTransformedByMergeOperation(t);
			return n.isCollapsed || i.push(n), i.map(t => new Cc(t, e.key, e.oldValue, e.newValue, e.baseVersion))
		}), du(Cc, Ec, (e, t) => function(e, t) {
			const i = oa._createFromPositionAndShift(t.sourcePosition, t.howMany);
			let n = null,
				o = [];
			...
			return r
		}(e.range, t).map(t => new Cc(t, e.key, e.oldValue, e.newValue, e.baseVersion))), du(Cc, Rc, (e, t) => {
			...
			if (e.range.start.hasSameParentAs(t.splitPosition) && e.range.containsPosition(t.splitPosition)) {
				const i = e.clone();
				return i.range = new oa(t.moveTargetPosition.clone(), e.range.end._getCombined(t.splitPosition, t.moveTargetPosition)), e.range.end = t.splitPosition.clone(), e.range.end.stickiness = "toPrevious", [e, i]
			}
			...
			if (e.shouldReceiveAttributes && e.position.hasSameParentAs(t.range.start) && t.range.containsPosition(e.position)) {
				const n = bu(e, t.key, t.newValue);
				n && i.push(n)
			}
			return i
		}), du(Pc, Pc, (e, t, i) => (e.position.isEqual(t.position) && i.aIsStrong || (e.position = e.position._getTransformedByInsertOperation(t)), [e])), du(Pc, Ec, (e, t) => (e.position = e.position._getTransformedByMoveOperation(t), [e])), du(Pc, Rc, (e, t) => (e.position = e.position._getTransformedBySplitOperation(t), [e])), du(Pc, Nc, (e, t) => (e.position = e.position._getTransformedByMergeOperation(t), [e])), du(Sc, Pc, (e, t) => (e.oldRange && (e.oldRange = e.oldRange._getTransformedByInsertOperation(t)[0]), e.newRange && (e.newRange = e.newRange._getTransformedByInsertOperation(t)[0]), [e])), du(Sc, Sc, (e, t, i) => {
			if (e.name == t.name) {
				if (!i.aIsStrong) return [new Zc(0)];
				e.oldRange = t.newRange ? t.newRange.clone() : null
			}
			return [e]
		}), du(Sc, Nc, (e, t) => (e.oldRange && (e.oldRange = e.oldRange._getTransformedByMergeOperation(t)), e.newRange && (e.newRange = e.newRange._getTransformedByMergeOperation(t)), [e])), du(Sc, Ec, (e, t, i) => {
			if (e.oldRange && (e.oldRange = oa._createFromRanges(e.oldRange._getTransformedByMoveOperation(t))), e.newRange) {
				if (i.abRelation) {
					const n = oa._createFromRanges(e.newRange._getTransformedByMoveOperation(t));
				...
				e.newRange = oa._createFromRanges(e.newRange._getTransformedByMoveOperation(t))
			}
			return [e]
		}), du(Sc, Rc, (e, t, i) => {
			if (e.oldRange && (e.oldRange = e.oldRange._getTransformedBySplitOperation(t)), e.newRange) {
				if (i.abRelation) {
					...
					return e.newRange.start.isEqual(t.splitPosition) && i.abRelation.wasStartBeforeMergedElement ? e.newRange.start = ea._createAt(t.insertionPosition) : e.newRange.start.isEqual(t.splitPosition) && !i.abRelation.wasInLeftElement && (e.newRange.start = ea._createAt(t.moveTargetPosition)), e.newRange.end.isEqual(t.splitPosition) && i.abRelation.wasInRightElement ? e.newRange.end = ea._createAt(t.moveTargetPosition) : e.newRange.end.isEqual(t.splitPosition) && i.abRelation.wasEndBeforeMergedElement ? e.newRange.end = ea._createAt(t.insertionPosition) : e.newRange.end = n.end, [e]
				}
				e.newRange = e.newRange._getTransformedBySplitOperation(t)
			}
			return [e]
		}), du(Nc, Pc, (e, t) => (e.sourcePosition.hasSameParentAs(t.position) && (e.howMany += t.howMany), e.sourcePosition = e.sourcePosition._getTransformedByInsertOperation(t), e.targetPosition = e.targetPosition._getTransformedByInsertOperation(t), [e])), du(Nc, Nc, (e, t, i) => {
			if (e.sourcePosition.isEqual(t.sourcePosition) && e.targetPosition.isEqual(t.targetPosition)) {
				if (i.bWasUndone) {
					...
					return i.push(0), e.sourcePosition = new ea(t.graveyardPosition.root, i), e.howMany = 0, [e]
				}
				return [new Zc(0)]
			}
			...
			const n = oa._createFromPositionAndShift(t.sourcePosition, t.howMany);
			return "remove" == t.type && !i.bWasUndone && !i.forceWeakRemove && e.deletionPosition.hasSameParentAs(t.sourcePosition) && n.containsPosition(e.sourcePosition) ? [new Zc(0)] : (e.sourcePosition.hasSameParentAs(t.targetPosition) && (e.howMany += t.howMany), e.sourcePosition.hasSameParentAs(t.sourcePosition) && (e.howMany -= t.howMany), e.sourcePosition = e.sourcePosition._getTransformedByMoveOperation(t), e.targetPosition = e.targetPosition._getTransformedByMoveOperation(t), e.graveyardPosition.isEqual(t.targetPosition) || (e.graveyardPosition = e.graveyardPosition._getTransformedByMoveOperation(t)), [e])
		}), du(Nc, Rc, (e, t, i) => {
			...
			const i = oa._createFromPositionAndShift(e.sourcePosition, e.howMany)._getTransformedByInsertOperation(t, !1)[0];
			...
			const n = oa._createFromPositionAndShift(e.sourcePosition, e.howMany),
				o = oa._createFromPositionAndShift(t.sourcePosition, t.howMany);
			let r, s = i.aIsStrong,
				a = !i.aIsStrong;
			if ("insertBefore" == i.abRelation || "insertAfter" == i.baRelation ? a = !0 : "insertAfter" != i.abRelation && "insertBefore" != i.baRelation || (a = !1), r = e.targetPosition.isEqual(t.targetPosition) && a ? e.targetPosition._getTransformedByDeletion(t.sourcePosition, t.howMany) : e.targetPosition._getTransformedByMove(t.sourcePosition, t.targetPosition, t.howMany), wu(e, t) && wu(t, e)) return [t.getReversed()];
			if (n.containsPosition(t.targetPosition) && n.containsRange(o, !0)) return n.start = n.start._getTransformedByMove(t.sourcePosition, t.targetPosition, t.howMany), n.end = n.end._getTransformedByMove(t.sourcePosition, t.targetPosition, t.howMany), ku([n], r);
			if (o.containsPosition(e.targetPosition) && o.containsRange(n, !0)) return n.start = n.start._getCombined(t.sourcePosition, t.getMovedRangeStart()), n.end = n.end._getCombined(t.sourcePosition, t.getMovedRangeStart()), ku([n], r);
			const c = cn(e.sourcePosition.getParentPath(), t.sourcePosition.getParentPath());
			if ("prefix" == c || "extension" == c) return n.start = n.start._getTransformedByMove(t.sourcePosition, t.targetPosition, t.howMany), n.end = n.end._getTransformedByMove(t.sourcePosition, t.targetPosition, t.howMany), ku([n], r);
			...
			return null !== u && s && (u.start = u.start._getCombined(t.sourcePosition, t.getMovedRangeStart()), u.end = u.end._getCombined(t.sourcePosition, t.getMovedRangeStart()), 0 === l.length ? l.push(u) : 1 == l.length ? o.start.isBefore(n.start) || o.start.isEqual(n.start) ? l.unshift(u) : l.push(u) : l.splice(1, 0, u)), 0 === l.length ? [new Zc(e.baseVersion)] : ku(l, r)
		}), du(Ec, Rc, (e, t, i) => {
			...
			const o = oa._createFromPositionAndShift(e.sourcePosition, e.howMany);
			...
			if (o.start.hasSameParentAs(t.splitPosition) && o.containsPosition(t.splitPosition)) {
				let e = new oa(t.splitPosition, o.end);
				e = e._getTransformedBySplitOperation(t);
				return ku([new oa(o.start, t.splitPosition), e], n)
			}
			...
			if (t.graveyardPosition) {
				...
				e.howMany > 1 && n && !i.aWasUndone && r.push(oa._createFromPositionAndShift(t.insertionPosition, 1))
			}
			return ku(r, n)
		}), du(Ec, Nc, (e, t, i) => {
			const n = oa._createFromPositionAndShift(e.sourcePosition, e.howMany);
			if (t.deletionPosition.hasSameParentAs(e.sourcePosition) && n.containsPosition(t.sourcePosition))
				if ("remove" != e.type || i.forceWeakRemove) {
					if (1 == e.howMany) return i.bWasUndone ? (e.sourcePosition = t.graveyardPosition.clone(), e.targetPosition = e.targetPosition._getTransformedByMergeOperation(t), [e]) : [new Zc(0)]
				} else if (!i.aWasUndone) {
				const i = [];
				let n = t.graveyardPosition.clone(),
					o = t.targetPosition._getTransformedByMergeOperation(t);
				e.howMany > 1 && (i.push(new Ec(e.sourcePosition, e.howMany - 1, e.targetPosition, 0)), n = n._getTransformedByMove(e.sourcePosition, e.targetPosition, e.howMany - 1), o = o._getTransformedByMove(e.sourcePosition, e.targetPosition, e.howMany - 1));
				const r = t.deletionPosition._getCombined(e.sourcePosition, e.targetPosition),
					s = new Ec(n, 1, r, 0),
					a = s.getMovedRangeStart().path.slice();
				a.push(0);
				const c = new ea(s.targetPosition.root, a);
				o = o._getTransformedByMove(n, r, 1);
				const l = new Ec(o, t.howMany, c, 0);
				return i.push(s), i.push(l), i
			}
			const o = oa._createFromPositionAndShift(e.sourcePosition, e.howMany)._getTransformedByMergeOperation(t);
		...
		}), du(Mc, Pc, (e, t) => (e.position = e.position._getTransformedByInsertOperation(t), [e])), du(Mc, Nc, (e, t) => e.position.isEqual(t.deletionPosition) ? (e.position = t.graveyardPosition.clone(), e.position.stickiness = "toNext", [e]) : (e.position = e.position._getTransformedByMergeOperation(t), [e])), du(Mc, Ec, (e, t) => (e.position = e.position._getTransformedByMoveOperation(t), [e])), du(Mc, Mc, (e, t, i) => {
			...
			if ("same" == cn(e.position.path, t.splitPosition.getParentPath()) && !t.graveyardPosition) {
				const t = new Mc(e.position.getShiftedBy(1), e.oldName, e.newName, 0);
				return [e, t]
			}
			return e.position = e.position._getTransformedBySplitOperation(t), [e]
		}), du(Ic, Ic, (e, t, i) => {
			if (e.root === t.root && e.key === t.key) {
				if (!i.aIsStrong || e.newValue === t.newValue) return [new Zc(0)];
				e.oldValue = t.newValue
			}
			return [e]
		}), du(Rc, Pc, (e, t) => (e.splitPosition.hasSameParentAs(t.position) && e.splitPosition.offset < t.position.offset && (e.howMany += t.howMany), e.splitPosition = e.splitPosition._getTransformedByInsertOperation(t), e.insertionPosition = e.insertionPosition._getTransformedByInsertOperation(t), [e])), du(Rc, Nc, (e, t, i) => {
			if (!e.graveyardPosition && !i.bWasUndone && e.splitPosition.hasSameParentAs(t.sourcePosition)) {
				const i = t.graveyardPosition.path.slice();
				i.push(0);
				const n = new ea(t.graveyardPosition.root, i),
					o = Rc.getInsertionPosition(new ea(t.graveyardPosition.root, i)),
					r = new Rc(n, 0, o, null, 0);
				return e.splitPosition = e.splitPosition._getTransformedByMergeOperation(t), e.insertionPosition = Rc.getInsertionPosition(e.splitPosition), e.graveyardPosition = r.insertionPosition.clone(), e.graveyardPosition.stickiness = "toNext", [r, e]
			}
			return e.splitPosition.hasSameParentAs(t.deletionPosition) && !e.splitPosition.isAfter(t.deletionPosition) && e.howMany--, e.splitPosition.hasSameParentAs(t.targetPosition) && (e.howMany += t.howMany), e.splitPosition = e.splitPosition._getTransformedByMergeOperation(t), e.insertionPosition = Rc.getInsertionPosition(e.splitPosition), e.graveyardPosition && (e.graveyardPosition = e.graveyardPosition._getTransformedByMergeOperation(t)), [e]
		}), du(Rc, Ec, (e, t, i) => {
			const n = oa._createFromPositionAndShift(t.sourcePosition, t.howMany);
			if (e.graveyardPosition) {
				...
				if (!i.bWasUndone && o) {
					const i = e.splitPosition._getTransformedByMoveOperation(t),
						...
						o = n.path.slice();
					o.push(0);
					const r = new ea(n.root, o);
					return [new Ec(i, e.howMany, r, 0)]
				}
				e.graveyardPosition = e.graveyardPosition._getTransformedByMoveOperation(t)
			}
			const o = e.splitPosition.isEqual(t.targetPosition);
			if (o && ("insertAtSource" == i.baRelation || "splitBefore" == i.abRelation)) return e.howMany += t.howMany, e.splitPosition = e.splitPosition._getTransformedByDeletion(t.sourcePosition, t.howMany), e.insertionPosition = Rc.getInsertionPosition(e.splitPosition), [e];
			...
			if (e.splitPosition.hasSameParentAs(t.sourcePosition) && n.containsPosition(e.splitPosition)) {
				...
				return e.howMany -= i, e.splitPosition.hasSameParentAs(t.targetPosition) && e.splitPosition.offset < t.targetPosition.offset && (e.howMany += t.howMany), e.splitPosition = t.sourcePosition.clone(), e.insertionPosition = Rc.getInsertionPosition(e.splitPosition), [e]
			}
			return t.sourcePosition.isEqual(t.targetPosition) || (e.splitPosition.hasSameParentAs(t.sourcePosition) && e.splitPosition.offset <= t.sourcePosition.offset && (e.howMany -= t.howMany), e.splitPosition.hasSameParentAs(t.targetPosition) && e.splitPosition.offset < t.targetPosition.offset && (e.howMany += t.howMany)), e.splitPosition.stickiness = "toNone", e.splitPosition = e.splitPosition._getTransformedByMoveOperation(t), e.splitPosition.stickiness = "toNext", e.graveyardPosition ? e.insertionPosition = e.insertionPosition._getTransformedByMoveOperation(t) : e.insertionPosition = Rc.getInsertionPosition(e.splitPosition), [e]
		}), du(Rc, Rc, (e, t, i) => {
			if (e.splitPosition.isEqual(t.splitPosition)) {
				if (!e.graveyardPosition && !t.graveyardPosition) return [new Zc(0)];
				if (e.graveyardPosition && t.graveyardPosition && e.graveyardPosition.isEqual(t.graveyardPosition)) return [new Zc(0)];
			...
			if (e.graveyardPosition && t.graveyardPosition && e.graveyardPosition.isEqual(t.graveyardPosition)) {
				...
				if (o && !n || !r && i.aIsStrong) {
					const i = [];
					return t.howMany && i.push(new Ec(t.moveTargetPosition, t.howMany, t.splitPosition, 0)), e.howMany && i.push(new Ec(e.splitPosition, e.howMany, e.moveTargetPosition, 0)), i
				}
				return [new Zc(0)]
			}
			...
			if (t.splitPosition.isEqual(e.insertionPosition) && "splitBefore" == i.baRelation) {
				...
				i.push(0);
				const n = new ea(t.insertionPosition.root, i);
				return [e, new Ec(e.insertionPosition, 1, n, 0)]
			}
			return e.splitPosition.hasSameParentAs(t.splitPosition) && e.splitPosition.offset < t.splitPosition.offset && (e.howMany -= t.howMany), e.splitPosition = e.splitPosition._getTransformedBySplitOperation(t), e.insertionPosition = Rc.getInsertionPosition(e.splitPosition), [e]
		});
		class _u extends ts {
			constructor(e) {
		...
		class vu extends ts {
			constructor(e) {
				super(e), this.domEventType = ["mousedown", "mouseup", "mouseover", "mouseout"]
			}
			onDomEvent(e) {
				this.fire(e.type, e)
			}
		...
		class xu extends yl {
			constructor(e, t) {
				super(e), this.view = t, this._toolbarConfig = Cd(e.config.get("toolbar")), this._elementReplacer = new vs
			}
			get element() {
		...
		class Au extends zd {
			constructor(e, t, i = {}) {
				super(e), this.stickyPanel = new iu(e), this.toolbar = new Td(e, {
					shouldGroupWhenFull: i.shouldToolbarGroupWhenFull
				}), this.editable = new jd(e, t)
			}
			render() {
		...
		class Cu extends kl {
			constructor(e, t) {
				...
				const i = !this.config.get("toolbar.shouldNotGroupWhenFull"),
					n = new Au(this.locale, this.editing.view, {
						shouldToolbarGroupWhenFull: i
					});
				this.ui = new xu(this, n),
					function(e) {
			...
			static create(e, t = {}) {
				return new Promise(i => {
					...
					i(n.initPlugins().then(() => n.ui.init(Yi(e) ? e : null)).then(() => {
						...
						const i = void 0 !== t.initialData ? t.initialData : function(e) {
		...
		class Eu extends ts {
			...
			onDomEvent(e) {
				const t = {
					dataTransfer: new Tu(e.clipboardData ? e.clipboardData : e.dataTransfer)
				};
		...
		class Su extends Qe {
			...
			init() {
				this.editor.editing.view.addObserver(Eu), this._setupPasteDrop(), this._setupCopyCut()
			}
			_setupPasteDrop() {
				const e = this.editor,
					t = e.model,
					...
					n.content.isEmpty || (n.dataTransfer.setData("text/html", this.editor.data.htmlProcessor.toData(n.content)), n.dataTransfer.setData("text/plain", function e(t) {
						...
						if (t.is("$text") || t.is("$textProxy")) i = t.data;
							...
							for (const o of t.getChildren()) {
								const t = e(o);
								n && (n.is("containerElement") || o.is("containerElement")) && (Pu.includes(n.name) || Pu.includes(o.name) ? i += "\n" : i += "\n\n"), i += t, n = o
							}
						}
						return i
			...
			execute() {
				...
				e.change(i => {
					! function(e, t, i, n) {
						...
						if (o) {
							const e = Mu(t.model.schema, i.getAttributes());
							Nu(t, r.start), t.setSelectionAttribute(e)
						} else {
							const n = !(r.start.isAtStart && r.end.isAtEnd),
								o = s == a;
							e.deleteContent(i, {
								leaveUnmerged: n
							}), n && (o ? Nu(t, i.focus) : t.setSelection(a, 0))
						}
		...
		class Ou extends Qe {
			...
			init() {
				const e = this.editor,
					t = e.editing.view,
					i = t.document;
				t.addObserver(Ru), e.commands.add("enter", new Iu(e)), this.listenTo(i, "enter", (i, n) => {
		...
		class Lu extends Ze {
			constructor(e, t) {
				super(e), this.direction = t, this._buffer = new Du(e.model, e.config.get("typing.undoStep"))
			}
			get buffer() {
				return this._buffer
			}
		...
		class zu extends Or {
			constructor(e) {
				...
				function n(e, i, n) {
					...
					t.fire(o, new es(t, i, n)), o.stop.called && e.stop()
				}
				t.on("keyup", (e, t) => {
		...
		class Vu extends Qe {
			...
			init() {
				const e = this.editor,
					...
					i = t.document;
				t.addObserver(zu);
				const n = new Lu(e, "forward");
				if (e.commands.add("deleteForward", n), e.commands.add("forwardDelete", n), e.commands.add("delete", new Lu(e, "backward")), this.listenTo(i, "delete", (i, n) => {
						const o = {
							unit: n.unit,
							sequence: n.sequence
						};
		...
		class ju {
			...
			add(e, t) {
				...
				const o = i[0];
				n === o || Bu(n, o) || this.fire("change:top", {
					oldDescriptor: n,
					newDescriptor: o,
					writer: t
				})
		...
		function Bu(e, t) {
			return e && t && e.priority == t.priority && Hu(e.classes) == Hu(t.classes)
		}

		function Fu(e, t) {
			return e.priority > t.priority || !(e.priority < t.priority) && Hu(e.classes) > Hu(t.classes)
		}
		...
		function Wu(e, t, i = {}) {
			...
			return t.setAttribute("contenteditable", "false", e), t.addClass("ck-widget", e), t.setCustomProperty("widget", !0, e), e.getFillerOffset = Xu, i.label && function(e, t, i) {
		...
		function Zu(e, t) {
			const i = new Ts(_r.window),
				n = i.getIntersection(e),
				o = t.height + Yd.arrowVerticalOffset;
			if (e.top - o > i.top || e.bottom + o < i.bottom) return null;
			const r = n || e,
				s = r.left + r.width / 2 - t.width / 2;
			return {
				top: Math.max(e.top, 0) + Yd.arrowVerticalOffset,
				left: s,
				name: "arrow_n"
			}
		}
		...
		function eh(e, t, i) {
			return e && Uu(e) && !i.isInline(t)
		}

		function th(e) {
			return e.getAttribute("widget-type-around")
		}
		const ih = [Ro("arrowUp"), Ro("arrowRight"), Ro("arrowDown"), Ro("arrowLeft"), 9, 16, 17, 18, 19, 20, 27, 33, 34, 35, 36, 45, 91, 93, 144, 145, 173, 174, 175, 176, 177, 178, 179, 255];
		for (let e = 112; e <= 135; e++) ih.push(e);

		function nh(e) {
			return !(!e.ctrlKey && !e.metaKey) || ih.includes(e.keyCode)
		}
		i(62);
		const oh = ["before", "after"],
			rh = (new DOMParser).parseFromString('<svg viewBox="0 0 10 8" xmlns="http://www.w3.org/2000/svg"><path d="M9.055.263v3.972h-6.77M1 4.216l2-2.038m-2 2 2 2.038"/></svg>', "image/svg+xml").firstChild;
		class sh extends Qe {
			static get pluginName() {
							...
							return function(e, t) {
									for (const i of oh) {
										const n = new Hl({
											...
											children: [e.ownerDocument.importNode(rh, !0)]
										});
			...
			_enableTypeAroundFakeCaretActivationUsingKeyboardArrows() {
				...
				this._listenToIfEnabled(o.document, "arrowKey", (e, t) => {
					...
					if (t) {
						if (eh(e.editing.mapper.toViewElement(t), t, n)) return
					}
					e.model.change(e => {
						e.removeSelectionAttribute("widget-type-around")
					})
					...
					if (this._currentFakeCaretModelElement) {
						...
						e && (o.removeClass(oh.map(r), e), this._currentFakeCaretModelElement = null)
					}
					const s = t.selection.getSelectedElement();
					if (!s) return;
					const a = i.mapper.toViewElement(s);
					if (!eh(a, s, n)) return;
					const c = th(t.selection);
			...
			_handleArrowKeyPress(e, t) {
				...
				let l;
				eh(c, i.editing.mapper.toModelElement(c), r) ? l = this._handleArrowKeyPressOnSelectedWidget(a) : o.isCollapsed && (l = this._handleArrowKeyPressWhenSelectionNextToAWidget(a)), l && (t.preventDefault(), e.stop())
			}
			_handleArrowKeyPressOnSelectedWidget(e) {
				const t = this.editor.model,
					i = th(t.document.selection);
				return t.change(t => {
			...
			_handleArrowKeyPressWhenSelectionNextToAWidget(e) {
				...
				return !!eh(t.editing.mapper.toViewElement(r), r, n) && (i.change(t => {
			...
			_enableInsertingParagraphsOnEnterKeypress() {
				...
				this._listenToIfEnabled(i.document, "enter", (i, n) => {
					...
					const o = t.getSelectedElement(),
						...
						s = e.model.schema;
					let a;
					this._insertParagraphAccordingToFakeCaretPosition() ? a = !0 : eh(r, o, s) && (this._insertParagraph(o, n.isSoft ? "before" : "after"), a = !0), a && (n.preventDefault(), i.stop())
				}, {
					context: Uu
				})
			}
			_enableInsertingParagraphsOnTypingKeystroke() {
				...
				this._listenToIfEnabled(e.document, "keydown", (e, i) => {
					t.includes(i.keyCode) || nh(i) || this._insertParagraphAccordingToFakeCaretPosition()
				}, {
					priority: "high"
				})
			}
			_enableDeleteIntegration() {
				...
				this._listenToIfEnabled(t.document, "delete", (t, o) => {
					...
					const r = th(i.document.selection);
					if (!r) return;
					const s = o.direction,
			...
			_enableDeleteContentIntegration() {
				...
				this._listenToIfEnabled(e.model, "deleteContent", (e, [i]) => {
		...
		class dh extends Qe {
			...
			init() {
				...
				this._previouslySelected = new Set, this.editor.editing.downcastDispatcher.on("selection", (e, t, i) => {
					...
					for (const e of o.getRanges())
						for (const t of e) {
							const e = t.item;
							Uu(e) && !uh(e, s) && (n.addClass("ck-widget_selected", e), this._previouslySelected.add(e), s = e, e == r && n.setSelection(o.getRanges(), {
								fake: !0,
								label: Gu(r)
							}))
						}
					...
					priority: "low"
				}), e.addObserver(vu), this.listenTo(t, "mousedown", (...e) => this._onMousedown(...e)), this.listenTo(t, "arrowKey", (...e) => {
					...
					context: "$root"
				}), this.listenTo(t, "arrowKey", ah(this.editor.editing), {
					context: "$text"
			...
			_onMousedown(e, t) {
				...
				if (!Uu(r) && (r = r.findAncestor(Uu), !r)) return;
		...
		var hh = function(e, t, i) {
			var n = !0,
				o = !0;
			if ("function" != typeof e) throw new TypeError("Expected a function");
			return w(i) && (n = "leading" in i ? !!i.leading : n, o = "trailing" in i ? !!i.trailing : o), ms(e, t, {
				leading: n,
				maxWait: t,
				trailing: o
			})
		...
		class fh extends Qe {
			...
			_setupDragging() {
				...
				this.listenTo(o, "dragstart", (n, r) => {
					...
					const c = r.target ? bh(r.target) : null;
					if (c) {
						const i = e.editing.mapper.toModelElement(c);
						this._draggedRange = ba.fromRange(t.createRangeOn(i))
					} else if (!o.selection.isCollapsed) {
						const e = o.selection.getSelectedElement();
						e && Uu(e) || (this._draggedRange = ba.fromRange(a.getFirstRange()))
					}
					...
					const n = gh(e, i.targetRanges, i.target);
			...
			_setupClipboardInputIntegration() {
				...
				this.listenTo(t, "clipboardInput", (t, i) => {
					...
					if ("move" == mh(i.dataTransfer) && this._draggedRange && this._draggedRange.containsRange(n, !0)) return this._finalizeDragging(!1), void t.stop();
			...
			_setupContentInsertionIntegration() {
				const e = this.editor.plugins.get(Su);
				e.on("contentInsertion", (e, t) => {
					...
					if (!this.isEnabled || "drop" !== t.method) return;
					const i = "move" == mh(t.dataTransfer),
			...
			_setupDraggableAttributeHandling() {
				...
				this.listenTo(i, "mousedown", (n, o) => {
					...
					let r = bh(o.target);
					if (Po.isBlink && !e.isReadOnly && !r && !i.selection.isCollapsed) {
						const e = i.selection.getSelectedElement();
						e && Uu(e) || (r = i.selection.editableElement)
					}
					r && (t.change(e => {
		...
		function gh(e, t, i) {
			...
			if (i.is("uiElement") && (i = i.parent), r = function(e, t) {
					const i = e.model,
						n = e.editing.mapper;
					if (Uu(t)) return i.createRangeOn(n.toModelElement(t));
					if (!t.is("editableElement")) {
						const e = t.findAncestor(e => Uu(e) || e.is("editableElement"));
						if (Uu(e)) return i.createRangeOn(n.toModelElement(e))
					}
					return null
				}(e, i), r) return r;
		...
		function bh(e) {
			...
			if (e.hasClass("ck-widget__selection-handle")) return e.findAncestor(Uu);
			if (Uu(e)) return e;
			const t = e.findAncestor(e => Uu(e) || e.is("editableElement"));
			return Uu(t) ? t : null
		}
		class wh extends Qe {
			static get pluginName() {
			...
			init() {
				...
				let r = !1;
				i.addObserver(Eu), this.listenTo(n, "keydown", (e, t) => {
					r = t.shiftKey
				}), e.plugins.get(Su).on("contentInsertion", (e, i) => {
					(r || function(e, t) {
				...
				e.change(i => {
					! function(e, t, i) {
						const n = i.isCollapsed,
							...
							a = r == s;
						if (n) {
							const n = Mu(e.schema, i.getAttributes());
							vh(e, t, o.end), t.removeSelectionAttribute(i.getAttributeKeys()), t.setSelectionAttribute(n)
						} else {
							const n = !(o.start.isAtStart && o.end.isAtEnd);
							e.deleteContent(i, {
								leaveUnmerged: n
							}), a ? vh(e, t, i.focus) : n && t.setSelection(s, 0)
						}
		...
		function yh(e, t) {
			return !e.is("rootElement") && (t.isLimit(e) || yh(e.parent, t))
		}
		class xh extends Qe {
			static get pluginName() {
				return "ShiftEnter"
			...
			init() {
				...
				}), n.addObserver(Ru), e.commands.add("shiftEnter", new _h(e)), this.listenTo(o, "enter", (t, i) => {
		...
		class Ah extends Ze {
			execute() {
				...
				if (t.containsEntireContent(i) || !Ch(e.schema, i))
					do {
		...
		class Eh extends Qe {
			...
			init() {
				const e = this.editor,
					t = e.editing.view.document;
				e.commands.add("selectAll", new Ah(e)), this.listenTo(t, "keydown", (t, i) => {
					Ro(i) === Th && (e.execute("selectAll"), i.preventDefault())
				})
			}
		}
		class Ph extends Qe {
		...
		class Mh extends Ze {
			constructor(e, t) {
				super(e), this._buffer = new Du(e.model, t), this._batches = new WeakSet
			}
			get buffer() {
				return this._buffer
			}
		...
		function Ih(e) {
			...
			}(hr(e.oldChildren, e.newChildren, Nh), e.newChildren);
			if (t.length > 1) return;
			const i = t[0];
		...
		class Rh {
			...
			handle(e, t) {
				if (function(e) {
						...
						for (const t of e)
							if ("children" === t.type && !Ih(t)) return !0;
						return !1
			...
			_handleContainerChildrenMutations(e, t) {
				...
				const n = this.editor.editing.view.domConverter.mapViewToDom(i),
					o = new Tr(this.editor.editing.view.document),
		...
		class Lh extends Qe {
			...
			init() {
				const e = this.editor,
					t = new Mh(e, e.config.get("typing.undoStep") || 20);
				e.commands.add("input", t),
					function(e) {
						...
						function r(e) {
							...
							t = null, o.isEnabled && (nh(e) || r.selection.isCollapsed || a && 229 === e.keyCode || !a && 229 === e.keyCode && c || s())
						}
		...
		class Bh extends Qe {
			...
			init() {
				...
				this.listenTo(i.document, "arrowKey", (e, t) => {
					...
					this._isNextGravityRestorationSkipped ? this._isNextGravityRestorationSkipped = !1 : this._isGravityOverridden && (!t.directChange && Wh(o.getFirstPosition(), this.attributes) || this._restoreGravity())
				})
			}
			registerAttribute(e) {
			...
			_handleForwardMovement(e) {
				...
				return !this._isGravityOverridden && ((!n.isAtStart || !Fh(i, t)) && (Wh(n, t) ? (Uh(e), this._overrideGravity(), !0) : void 0))
			}
			_handleBackwardMovement(e) {
				...
				return this._isGravityOverridden ? (Uh(e), this._restoreGravity(), Hh(i, t, o), !0) : o.isAtStart ? !!Fh(n, t) && (Uh(e), Hh(i, t, o), !0) : function(e, t) {
					return Wh(e.getShiftedBy(-1), t)
				}(o, t) ? o.isAtEnd && !Fh(n, t) && Wh(o, t) ? (Uh(e), Hh(i, t, o), !0) : (this._isNextGravityRestorationSkipped = !0, this._overrideGravity(), !1) : void 0
			}
		...
		var qh = /[\\^$.*+?()[\]{}|]/g,
			$h = RegExp(qh.source);
		var Yh = function(e) {
			return (e = Sn(e)) && $h.test(e) ? e.replace(qh, "\\$&") : e
		};
		const Gh = {
				copyright: {
					from: "(c)",
		...
		function Jh(e) {
			return "string" == typeof e ? new RegExp(`(${Yh(e)})$`) : e
		}
		...
		function tf(e, t, i, n) {
			return n.createRange(nf(e, t, i, !0, n), nf(e, t, i, !1, n))
		}

		function nf(e, t, i, n, o) {
		...
		class of extends Ze {
			...
			_restoreSelection(e, t, i) {
				const n = this.editor.model,
					...
					a = s.flat();
				for (const e of s) {
					const t = e.filter(e => e.root != o.graveyard).filter(e => !sf(e, a));
					t.length && (rf(t), r.push(t[0]))
				}
				r.length && n.change(e => {
					e.setSelection(r, {
						backward: t
		...
		class lf extends Qe {
			...
			init() {
				const e = this.editor;
				this._undoCommand = new af(e), this._redoCommand = new cf(e), e.commands.add("undo", this._undoCommand), e.commands.add("redo", this._redoCommand), this.listenTo(e.model, "applyOperation", (e, t) => {
					const i = t[0];
		...
		var df = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="m5.042 9.367 2.189 1.837a.75.75 0 0 1-.965 1.149l-3.788-3.18a.747.747 0 0 1-.21-.284.75.75 0 0 1 .17-.945L6.23 4.762a.75.75 0 1 1 .964 1.15L4.863 7.866h8.917A.75.75 0 0 1 14 7.9a4 4 0 1 1-1.477 7.718l.344-1.489a2.5 2.5 0 1 0 1.094-4.73l.008-.032H5.042z"/></svg>',
			uf = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="m14.958 9.367-2.189 1.837a.75.75 0 0 0 .965 1.149l3.788-3.18a.747.747 0 0 0 .21-.284.75.75 0 0 0-.17-.945L13.77 4.762a.75.75 0 1 0-.964 1.15l2.331 1.955H6.22A.75.75 0 0 0 6 7.9a4 4 0 1 0 1.477 7.718l-.344-1.489A2.5 2.5 0 1 1 6.039 9.4l-.008-.032h8.927z"/></svg>';
		class hf extends Qe {
			static get pluginName() {
				return "UndoUI"
			}
			init() {
				const e = this.editor,
					t = e.locale,
					i = e.t,
					n = "ltr" == t.uiLanguageDirection ? df : uf,
					o = "ltr" == t.uiLanguageDirection ? uf : df;
		...
		class mf extends Qe {
			...
			createLoader(e) {
				...
				const t = new pf(Promise.resolve(e), this.createUploadAdapter);
		...
		class pf {
			constructor(e, t) {
				this.id = s(), this._filePromiseWrapper = this._createFilePromiseWrapper(e), this._adapter = t(this), this._reader = new gf, this.set("status", "idle"), this.set("uploaded", 0), this.set("uploadTotal", null), this.bind("uploadedPercent").to(this, "uploaded", this, "uploadTotal", (e, t) => t ? e / t * 100 : 0), this.set("uploadResponse", null)
			}
			get file() {
		...
		class bf extends Fl {
			constructor(e) {
				super(e), this.buttonView = new dd(e), this._fileInputView = new wf(e), this._fileInputView.bind("acceptedType").to(this), this._fileInputView.bind("allowMultipleFiles").to(this), this._fileInputView.delegate("done").to(this), this.setTemplate({
					tag: "span",
					attributes: {
		...
		class _f {
			...
			_sendRequest(e) {
				...
				t.append("upload", e), t.append("ckCsrfToken", kf()), this.xhr.send(t)
			}
		}
		...
		function vf(e, t, i, n) {
			...
			"function" == typeof n ? o = n : (r = e.commands.get(n), o = () => {
				...
				const c = Ns(e.model.document.selection.getRanges());
		...
		function yf(e, t, i, n) {
			...
			i instanceof RegExp ? o = i : r = i, r = r || (e => {
				...
				const d = a.focus,
					...
					g = r(h),
					m = xf(f.start, g.format, s),
					p = xf(f.start, g.remove, s);
		...
		class Tf extends Qe {
			...
			init() {
				...
				}), e.commands.add("bold", new Cf(e, "bold")), e.keystrokes.set("CTRL+B", "bold")
			}
		}
		class Ef extends Qe {
			static get pluginName() {
		...
		class Pf extends Qe {
			...
			init() {
				...
				}), e.commands.add("italic", new Cf(e, "italic")), e.keystrokes.set("CTRL+I", "italic")
			}
		}
		class Sf extends Qe {
			static get pluginName() {
		...
		class Mf extends Ze {
			...
			execute(e = {}) {
				...
				t.change(e => {
					if (r) {
						const t = o.filter(e => If(e) || Rf(i, e));
						this._applyQuote(e, t)
					} else this._removeQuote(e, o.filter(If))
				})
			}
			_getValue() {
				const e = Ns(this.editor.model.document.selection.getSelectedBlocks());
				return !(!e || !If(e))
			}
			_checkEnabled() {
				...
				const e = this.editor.model.document.selection,
					...
					i = Ns(e.getSelectedBlocks());
				return !!i && Rf(t, i)
			}
			_removeQuote(e, t) {
				Nf(e, t).reverse().forEach(t => {
		...
		class Of extends Qe {
			...
			init() {
				const e = this.editor,
					t = e.model.schema;
				e.commands.add("blockQuote", new Mf(e)), t.register("blockQuote", {
					allowWhere: "$block",
					allowContentOf: "$root"
		...
		class jf extends Qe {
			...
			static get requires() {
				return [Ud, "ImageEditing", "LinkEditing"]
			}
			init() {
				const e = this.editor;
				e.commands.add("ckfinder", new zf(e))
			}
		}
		class Bf extends Qe {
			static get pluginName() {
			...
			init() {
				const e = this.editor,
					...
					i = t.token,
					n = t.uploadUrl;
				i && (this._uploadGateway = e.plugins.get("CloudServicesCore").createUploadGateway(i, n), e.plugins.get(mf).createUploadAdapter = e => new Ff(this._uploadGateway, e))
			}
		}
		class Ff {
			constructor(e, t) {
		...
		class Hf extends Ze {
			refresh() {
				const e = this.editor.model,
					t = Ns(e.document.selection.getSelectedBlocks());
				this.value = !!t && t.is("element", "paragraph"), this.isEnabled = !!t && Uf(t, e.schema)
			}
			execute(e = {}) {
				const t = this.editor.model,
					i = t.document;
				t.change(n => {
					...
					for (const e of o) !e.is("element", "paragraph") && Uf(e, t.schema) && n.rename(e, "paragraph")
				})
			}
		}
		...
		class qf extends Qe {
			...
			init() {
				const e = this.editor,
					t = e.model;
				e.commands.add("paragraph", new Hf(e)), e.commands.add("insertParagraph", new Wf(e)), t.schema.register("paragraph", {
					...
					model: (e, {
						writer: t
					}) => qf.paragraphLikeElements.has(e.name) ? e.isEmpty ? null : t.createElement("paragraph") : null,
					view: /.+/,
					converterPriority: "low"
				})
			}
		}
		qf.paragraphLikeElements = new Set(["blockquote", "dd", "div", "dt", "h1", "h2", "h3", "h4", "h5", "h6", "li", "p", "td", "th"]);
		class $f extends Ze {
			constructor(e, t) {
			...
			refresh() {
				const e = Ns(this.editor.model.document.selection.getSelectedBlocks());
				this.value = !!e && this.modelElements.includes(e.name) && e.name, this.isEnabled = !!e && this.modelElements.some(t => Yf(e, t, this.editor.model.schema))
			}
			execute(e) {
				const t = this.editor.model,
					i = t.document,
					n = e.value;
				t.change(e => {
					const o = Array.from(i.selection.getSelectedBlocks()).filter(e => Yf(e, n, t.schema));
		...
		class Gf extends Qe {
			...
			init() {
				...
				this._addDefaultH1Conversion(e), e.commands.add("heading", new $f(e, i))
			}
			afterInit() {
				const e = this.editor,
		...
		class Kf extends Qe {
			...
			init() {
				...
				e.ui.componentFactory.add("heading", t => {
					...
					const d = Rd(t);
					return Od(d, s), d.buttonView.set({
						isOn: !1,
						withText: !0,
						tooltip: o
					}), d.extendTemplate({
		...
		class Qf extends Qe {
			...
			_showToolbar(e, t) {
				this._isToolbarVisible(e) ? Jf(this.editor, t) : this._isToolbarInBalloon(e) || (this._balloon.add({
					view: e.view,
					position: Zf(this.editor, t),
		...
		function Zf(e, t) {
			const i = e.editing.view,
				n = Yd.defaultPositions;
			return {
				target: i.domConverter.mapViewToDom(t),
				positions: [n.northArrowSouth, n.northArrowSouthWest, n.northArrowSouthEast, n.southArrowNorth, n.southArrowNorthWest, n.southArrowNorthEast, Zu]
			}
		}
		class Xf {
			constructor(e) {
		...
		class eg {
			...
			begin(e) {
				this.state = new Xf(this._options), this._sizeUI.bindToState(this._options, this.state), this._initialViewWidth = this._options.viewElement.getStyle("width"), this.state.begin(e, this._getHandleHost(), this._getResizeHost())
			}
			updateSize(e) {
			...
			_appendHandles(e) {
				const t = ["top-left", "top-right", "bottom-right", "bottom-left"];
				for (const n of t) e.appendChild(new Hl({
					tag: "div",
					attributes: {
		...
		Ke(class extends Qe {
			...
			init() {
				...
				const e = _r.window.document;
				this.editor.model.schema.setAttributeProperties("width", {
					isFormatting: !0
				}), this.editor.editing.view.addObserver(vu), this._observer = Object.create(Ir), this.listenTo(this.editor.editing.view.document, "mousedown", this._mouseDownListener.bind(this), {
					priority: "high"
				...
				this._redrawFocusedResizerThrottled = hh(t, 200), this.on("change:visibleResizer", t), this.editor.ui.on("update", this._redrawFocusedResizerThrottled), this._observer.listenTo(_r.window, "resize", this._redrawFocusedResizerThrottled);
			...
			_mouseDownListener(e, t) {
				const i = t.domTarget;
				eg.isResizeHandle(i) && (this._activeResizer = this._getResizerByHandle(i), this._activeResizer && (this._activeResizer.begin(i), e.stop(), t.preventDefault()))
			}
		...
		function ng(e) {
			return !!e.getCustomProperty("image") && Uu(e)
		}

		function og(e) {
			const t = e.getSelectedElement();
			return t && ng(t) ? t : null
		}
		...
		function lg(e) {
			...
			function t(e, t, i) {
				if (!i.consumable.consume(t.item, e.name)) return;
				const n = i.writer,
					o = cg(i.mapper.toViewElement(t.item));
				n.setAttribute(t.attributeKey, t.attributeNewValue || "", o)
			}
		}
		class dg extends Ze {
			refresh() {
				this.isEnabled = ag(this.editor.model)
			}
			execute(e) {
				const t = this.editor.model;
				for (const i of en(e.source)) sg(t, {
					src: i
				})
			}
		}
		class ug extends Qe {
			...
			init() {
				const e = this.editor,
					...
					i = e.t,
					n = e.conversion;
				e.editing.view.addObserver(ig), t.register("image", {
					isObject: !0,
					isBlock: !0,
					allowWhere: "$block",
					...
					view: (e, {
						...
						return t.setCustomProperty("image", !0, e), Wu(e, t, {
							label: function() {
								const t = cg(e).getAttribute("alt");
								return t ? `${t} ${i}` : i
							}
						})
					}(hg(t), t, i("image widget"))
				}), n.for("downcast").add(lg("src")).add(lg("alt")).add(function() {
					return t => {
					...
					function e(e, t, i) {
						...
						const n = cg(t.viewItem);
						if (!n || !n.hasAttribute("src") || !i.consumable.test(n, {
								name: !0
							})) return;
						const o = Ns(i.convertItem(n, t.modelCursor).modelRange.getItems());
		...
		class fg extends Ze {
			refresh() {
				...
				this.isEnabled = rg(e), rg(e) && e.hasAttribute("alt") ? this.value = e.getAttribute("alt") : this.value = !1
			}
			execute(e) {
				const t = this.editor.model,
		...
		class gg extends Qe {
			...
			init() {
				this.editor.commands.add("imageTextAlternative", new fg(this.editor))
			}
		}
		i(73), i(7);
		class mg extends Fl {
			...
			render() {
				super.render(), this.keystrokes.listenTo(this.element), jl({
					view: this
		...
		class bg extends Qe {
			...
			_createForm() {
				const e = this.editor,
					t = e.editing.view.document;
				this._balloon = this.editor.plugins.get("ContextualBalloon"), this._form = new mg(e.locale), this._form.render(), this.listenTo(this._form, "submit", () => {
					...
					og(t.selection) ? this._isVisible && function(e) {
						const t = e.plugins.get("ContextualBalloon");
						if (og(e.editing.view.document.selection)) {
							const i = pg(e);
							t.updatePosition(i)
						}
					}(e) : this._hideForm(!0)
		...
		class vg extends Qe {
			...
			init() {
				const e = this.editor,
					...
					o = e.editing,
					r = e.t;
				i.isRegistered("caption") ? i.extend("caption", {
					allowIn: "image"
				}) : i.register("caption", {
					allowIn: "image",
				...
				n.downcastDispatcher.on("insert:caption", yg(e => e.createContainerElement("figcaption"), !1));
				const s = function(e, t) {
					return i => {
						const n = i.createEditableElement("figcaption");
						return i.setCustomProperty("imageCaption", !0, n), ou({
							view: e,
							element: n,
							text: t
						}), Ku(n, i)
				...
				o.downcastDispatcher.on("insert:caption", yg(s)), o.downcastDispatcher.on("insert", this._fixCaptionVisibility(e => e.item), {
					priority: "high"
			...
			_updateCaptionVisibility(e) {
				...
				const s = xg(o.getFirstPosition().parent);
				if (s && (n = t.toViewElement(s)), n && !this.editor.isReadOnly) return i ? (i === n || (Ag(i, e), this._lastSelectedCaption = n), Cg(n, e)) : (this._lastSelectedCaption = n, Cg(n, e));
				if (i) {
					const t = Ag(i, e);
			...
			_insertMissingModelCaptionElement(e) {
				...
				for (const e of i)
					if ("insert" == e.type && "$text" != e.name) {
						...
						if (i.is("element", "image") && !kg(i) && n.push(i), !i.is("element", "image") && i.childCount)
							for (const e of t.createRangeIn(i).getItems()) e.is("element", "image") && !kg(e) && n.push(e)
		...
		function Ig(e) {
			if ("string" == typeof e) {
				const t = e;
				Pg[t] ? e = Object.assign({}, Pg[t]) : (Object(c.b)("image-style-not-found", {
					name: t
				}), e = {
					name: t
				})
			...
			return "string" == typeof e.icon && Sg[e.icon] && (e.icon = Sg[e.icon]), e
		}
		class Ng extends Qe {
			static get pluginName() {
			...
			init() {
				...
				const o = Mg(e.config.get("image.styles"));
				t.extend("image", {
				...
				const r = function(e) {
					return (t, i, n) => {
						if (!n.consumable.consume(i.item, t.name)) return;
						const o = Eg(i.attributeNewValue, e),
							r = Eg(i.attributeOldValue, e),
				...
				n.downcastDispatcher.on("attribute:imageStyle:image", r), i.downcastDispatcher.on("attribute:imageStyle:image", r), i.upcastDispatcher.on("element:figure", function(e) {
					...
					priority: "low"
				}), e.commands.add("imageStyle", new Tg(e, o))
			}
		}
		i(80);
		class Rg extends Qe {
			...
			init() {
				const e = function(e, t) {
					...
					return e
				}(Mg(this.editor.config.get("image.styles")), this.localizedDefaultStylesTitles);
		...
		function Dg(e) {
			return new Promise((t, i) => {
				...
				fetch(n).then(e => e.blob()).then(e => {
					...
					return function(e) {
						return new Promise((t, i) => {
							const n = _r.document.createElement("img");
							n.addEventListener("load", () => {
								const e = _r.document.createElement("canvas");
		...
		class Vg extends Qe {
			...
			uploadStatusChange(e, t, i) {
				...
				if (!i.consumable.consume(t.item, e.name)) return;
				const s = n.plugins.get(mf),
					a = r ? t.attributeNewValue : null,
					c = this.placeholder,
					l = n.editing.mapper.toViewElement(o),
					d = i.writer;
				if ("reading" == a) return jg(l, d), void Bg(c, l, d);
				if ("uploading" == a) {
					const e = s.loaders.get(r);
					return jg(l, d), void(e ? (Fg(l, d), function(e, t, i, n) {
						const o = function(e) {
		...
		function Bg(e, t, i) {
			...
			const n = cg(t);
			n.getAttribute("src") !== e && i.setAttribute("src", e, n), Hg(t, "placeholder") || i.insert(i.createPositionAfter(n), function(e) {
				const t = e.createUIElement("div", {
		...
		function Fg(e, t) {
			e.hasClass("ck-image-upload-placeholder") && t.removeClass("ck-image-upload-placeholder", e), Ug(e, t, "placeholder")
		}
		...
		class Wg extends Ze {
			refresh() {
				const e = this.editor.model.document.selection.getSelectedElement(),
					t = e && "image" === e.name || !1;
				this.isEnabled = ag(this.editor.model) || t
			}
			execute(e) {
				const t = this.editor,
					i = t.model,
					n = t.plugins.get(mf);
				for (const t of en(e.file)) qg(i, n, t)
			}
		}
		...
		class $g extends Qe {
			...
			init() {
				const e = this.editor,
					...
					n = e.conversion,
					o = e.plugins.get(mf),
					r = Og(e.config.get("image.upload.types"));
				i.extend("image", {
				...
				e.commands.add("uploadImage", s), e.commands.add("imageUpload", s), n.for("upcast").attributeToAttribute({
					...
					if (!n.length) return;
					const r = new yu(e.editing.view.document);
					for (const e of n) {
			...
			_readAndUpload(e, t) {
				...
				return n.enqueueChange("transparent", e => {
					...
					const o = e.upload();
					if (Po.isSafari) {
						const e = cg(i.editing.mapper.toViewElement(t));
					...
					n.enqueueChange("transparent", i => {
						i.setAttribute("uploadStatus", "complete", t), this.fire("uploadComplete", {
							data: e,
							imageElement: t
						})
					}), a()
		...
		class Jg extends Qe {
			...
			init() {
				const e = this.editor,
					t = e.locale,
					i = e.t,
					n = "ltr" == t.uiLanguageDirection ? Kg : Qg,
					o = "ltr" == t.uiLanguageDirection ? Qg : Kg;
		...
		var Xg = function(e, t, i) {
				var n = e.length;
				return i = void 0 === i ? n : i, !t && i >= n ? e : On(e, t, i)
			},
			em = RegExp("[\\u200d\\ud800-\\udfff\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff\\ufe0e\\ufe0f]");
		var tm = function(e) {
			return em.test(e)
		};
		var im = function(e) {
			...
			cm = "[\\ud800-\\udbff][\\udc00-\\udfff]",
			lm = "(?:" + om + "|" + rm + ")" + "?",
			dm = "[\\ufe0e\\ufe0f]?" + lm + ("(?:\\u200d(?:" + [sm, am, cm].join("|") + ")[\\ufe0e\\ufe0f]?" + lm + ")*"),
			um = "(?:" + [sm + om + "?", om, am, cm, nm].join("|") + ")",
			hm = RegExp(rm + "(?=" + rm + ")|" + um + dm, "g");
		var fm = function(e) {
			return e.match(hm) || []
		};
		var gm = function(e) {
			return tm(e) ? fm(e) : im(e)
		};
		var mm = function(e) {
			return function(t) {
				t = Sn(t);
				var i = tm(t) ? gm(t) : void 0,
					n = i ? i[0] : t.charAt(0),
					o = i ? Xg(i, 1).join("") : t.slice(1);
				return n[e]() + o
			}
		}("toUpperCase");
		const pm = /[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205f\u3000]/g,
			bm = /^(?:(?:https?|ftps?|mailto):|[^a-z]|[a-z+.-]+(?:[^a-z+.:-]|$))/i,
			wm = /^[\S]+@((?![-_])(?:[-\w\u00a1-\uffff]{0,63}[^-_]\.))+(?:[a-z\u00a1-\uffff]{2,})$/i,
			km = /^((\w+:(\/{2,})?)|(\W))/i;
		...
		function xm(e, t) {
			const i = (n = e, wm.test(n) ? "mailto:" : t);
			var n;
			const o = !!i && !km.test(e);
			return e && o ? i + e : e
		}
		class Am extends Ze {
			constructor(e) {
				super(e), this.manualDecorators = new Zi, this.automaticDecorators = new Zg
			}
			...
			refresh() {
				const e = this.editor.model,
					t = e.document,
					i = Ns(t.selection.getSelectedBlocks());
				ym(i, e.schema) ? (this.value = i.getAttribute("linkHref"), this.isEnabled = e.schema.checkAttribute(i, "linkHref")) : (this.value = t.selection.getAttribute("linkHref"), this.isEnabled = e.schema.checkAttributeInSelection(t.selection, "linkHref"));
				for (const e of this.manualDecorators) e.value = this._getDecoratorStateFromModel(e.id)
			}
			execute(e, t = {}) {
				const i = this.editor.model,
				...
				i.change(t => {
					if (n.isCollapsed) {
						...
						if (n.hasAttribute("linkHref")) {
							const a = tf(s, "linkHref", n.getAttribute("linkHref"), i);
			...
			_getDecoratorStateFromModel(e) {
				const t = this.editor.model,
					i = t.document,
					n = Ns(i.selection.getSelectedBlocks());
				return ym(n, t.schema) ? n.getAttribute(e) : i.selection.getAttribute(e)
			}
		...
		class Cm extends Ze {
			refresh() {
				const e = this.editor.model,
					t = e.document,
					i = Ns(t.selection.getSelectedBlocks());
				ym(i, e.schema) ? this.isEnabled = e.schema.checkAttribute(i, "linkHref") : this.isEnabled = e.schema.checkAttributeInSelection(t.selection, "linkHref")
			}
			execute() {
				const e = this.editor,
					t = this.editor.model,
				...
				t.change(e => {
					const o = i.isCollapsed ? [tf(i.getFirstPosition(), "linkHref", i.getAttribute("linkHref"), t)] : t.schema.getValidRanges(i.getRanges(), "linkHref");
					for (const t of o)
		...
		class Pm extends Qe {
			...
			init() {
				...
				}), e.commands.add("link", new Am(e)), e.commands.add("unlink", new Cm(e));
				const t = function(e, t) {
					const i = {
				...
				e.plugins.get(Bh).registerAttribute("linkHref"),
					function(e, t, i, n) {
						...
						o.document.registerPostFixer(o => {
							...
							let a = !1;
							if (s.hasAttribute(t)) {
								const c = tf(s.getFirstPosition(), t, s.getAttribute(t), e.model),
			...
			_enableManualDecorators(e) {
				...
				e.forEach(e => {
					...
					}), i.add(new Tm(e)), t.conversion.for("downcast").attributeToElement({
						model: e.id,
						view: (t, {
							writer: n
						}) => {
			...
			_enableClickingAfterLink() {
				...
				this.listenTo(e.editing.view.document, "mousedown", () => {
					...
					const n = e.getFirstPosition(),
						o = tf(n, "linkHref", e.getAttribute("linkHref"), t);
					(n.isTouching(o.start) || n.isTouching(o.end)) && t.change(e => {
						Sm(e, Im(t.schema))
					})
				})
			}
			_enableTypingOverLink() {
				...
				this.listenTo(t.document, "delete", () => {
					...
					t.isCollapsed || (n ? n = !1 : Mm(e) && function(e) {
						...
						if (o === r) return !0;
						return tf(i, "linkHref", o.getAttribute("linkHref"), e).containsRange(e.createRange(i, n), !0)
					}(e.model) && (i = t.getAttributes()))
				}, {
					priority: "high"
				}), this.listenTo(e.model, "insertContent", (t, [o]) => {
					n = !1, Mm(e) && i && (e.model.change(e => {
			...
			_handleDeleteContentAfterLink() {
				...
				this.listenTo(n.document, "delete", (e, t) => {
					r = t.domEvent.keyCode === Io.backspace
				}, {
					priority: "high"
					...
					if (!n) return;
					const r = tf(e, "linkHref", n, t);
					o = r.containsPosition(e) || r.end.isEqual(e)
				}, {
					priority: "high"
				}), this.listenTo(t, "deleteContent", () => {
					r && (r = !1, o || e.model.enqueueChange(e => {
						Sm(e, Im(t.schema))
					}))
				}, {
					priority: "low"
		...
		class Rm extends Fl {
			constructor(e) {
				super(e);
				const t = e.t;
				this.focusTracker = new Rs, this.keystrokes = new Os, this.previewButtonView = this._createPreviewButton(), this.unlinkButtonView = this._createButton(t("Unlink"), '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="m11.077 15 .991-1.416a.75.75 0 1 1 1.229.86l-1.148 1.64a.748.748 0 0 1-.217.206 5.251 5.251 0 0 1-8.503-5.955.741.741 0 0 1 .12-.274l1.147-1.639a.75.75 0 1 1 1.228.86L4.933 10.7l.006.003a3.75 3.75 0 0 0 6.132 4.294l.006.004zm5.494-5.335a.748.748 0 0 1-.12.274l-1.147 1.639a.75.75 0 1 1-1.228-.86l.86-1.23a3.75 3.75 0 0 0-6.144-4.301l-.86 1.229a.75.75 0 0 1-1.229-.86l1.148-1.64a.748.748 0 0 1 .217-.206 5.251 5.251 0 0 1 8.503 5.955zm-4.563-2.532a.75.75 0 0 1 .184 1.045l-3.155 4.505a.75.75 0 1 1-1.229-.86l3.155-4.506a.75.75 0 0 1 1.045-.184zm4.919 10.562-1.414 1.414a.75.75 0 1 1-1.06-1.06l1.414-1.415-1.415-1.414a.75.75 0 0 1 1.061-1.06l1.414 1.414 1.414-1.415a.75.75 0 0 1 1.061 1.061l-1.414 1.414 1.414 1.415a.75.75 0 0 1-1.06 1.06l-1.415-1.414z"/></svg>', "unlink"), this.editButtonView = this._createButton(t("Edit link"), Ol, "edit"), this.set("href"), this._focusables = new Bl, this._focusCycler = new hd({
					focusables: this._focusables,
					focusTracker: this.focusTracker,
					keystrokeHandler: this.keystrokes,
					actions: {
		...
		class Om extends Qe {
			...
			init() {
				const e = this.editor;
				e.editing.view.addObserver(_u), this.actionsView = this._createActionsView(), this.formView = this._createFormView(), this._balloon = e.plugins.get(Zd), this._createToolbarLinkButton(), this._enableUserBalloonInteractions(), e.conversion.for("editingDowncast").markerToHighlight({
					model: "link-ui",
					view: {
			...
			_createFormView() {
				...
				return n.urlInputView.fieldView.bind("value").to(t, "value"), n.urlInputView.bind("isReadOnly").to(t, "isEnabled", e => !e), n.saveButtonView.bind("isEnabled").to(t), this.listenTo(n, "submit", () => {
					const {
						value: t
					} = n.urlInputView.fieldView.element, o = xm(t, i);
			...
			_getSelectedLinkElement() {
				const e = this.editor.editing.view,
					t = e.document.selection;
				if (t.isCollapsed) return Dm(t.getFirstPosition()); {
		...
		const Lm = new RegExp("(^|\\s)(((?:(?:(?:https?|ftp):)?\\/\\/)(?:\\S+(?::\\S*)?@)?(?:(?:[1-9]\\d?|1\\d\\d|2[01]\\d|22[0-3])(?:\\.(?:1?\\d{1,2}|2[0-4]\\d|25[0-5])){2}(?:\\.(?:[1-9]\\d?|1\\d\\d|2[0-4]\\d|25[0-4]))|(((?!www\\.)|(www\\.))(?![-_])(?:[-_a-z0-9\\u00a1-\\uffff]{1,63}\\.)+(?:[a-z\\u00a1-\\uffff]{2,63})))(?::\\d{2,5})?(?:[/?#]\\S*)?)|((www.|(\\S+@))((?![-_])(?:[-_a-z0-9\\u00a1-\\uffff]{1,63}\\.))+(?:[a-z\\u00a1-\\uffff]{2,63})))$", "i");
		class zm extends Qe {
			static get pluginName() {
				return "AutoLink"
			}
			...
			_enableTypingHandling() {
				const e = this.editor,
					t = new jh(e.model, e => {
						...
						const t = Vm(e.substr(0, e.length - 1));
						return t ? {
							url: t
						} : void 0
					}),
		...
		class jm extends Ze {
			...
			execute(e = {}) {
				const t = this.editor.model,
					i = t.document,
					n = Array.from(i.selection.getSelectedBlocks()).filter(e => Fm(e, t.schema)),
				...
				t.change(e => {
					...
					if (!o) {
						...
						e = 0 === e ? 1 : e, Bm(n, !0, e), Bm(n, !1, e)
					}
					for (const t of n.reverse()) o && "listItem" == t.name ? e.rename(t, "paragraph") : o || "listItem" == t.name ? o || "listItem" != t.name || t.getAttribute("listType") == this.type || e.setAttribute("listType", this.type, t) : (e.setAttributes({
						listType: this.type,
						listIndent: 0
		...
		function Wm(e, t, i, n) {
			...
			if (a = $m(a), s.insert(a, o), l && "listItem" == l.name) {
				...
				for (const e of i)
					if (e.item.is("element", "li")) {
						...
						qm(s, r.nodeBefore, r.nodeAfter), s.move(s.createRangeOn(o), r), i.position = n
					}
			} else {
			...
			qm(s, o, o.nextSibling), qm(s, o.previousSibling, o)
		}
		...
		function Zm(e, t, i) {
			const n = i.mapper.toViewElement(t.item).parent,
				o = i.writer;
			qm(o, n, n.nextSibling), qm(o, n.previousSibling, n);
				...
				if (o.length > 0) {
					for (let t = 0; t < o.length; t++) {
						...
						if (e = n.insert(e, o[t]).end, t > 0) {
							const t = qm(n, i, i.nextSibling);
							t && t.parent == i && e.offset--
						}
					}
					qm(n, e.nodeBefore, e.nodeAfter)
				}
			}
		}
				...
				const s = function(e, t, i) {
					...
					for (const s of t)
						if ("ul" == s.name || "ol" == s.name) r = i.convertItem(s, r).modelCursor;
							...
							a && a.is("element") && !o.checkChild(e, a.name) && (e = t.modelCursor.parent.is("element", "listItem") ? t.modelCursor.parent : sp(t.modelCursor), r = n.createPositionAfter(e))
						} return r
		...
		function ip(e, t, i) {
			if (i.consumable.test(t.viewItem, {
				...
				for (const t of e) {
					!(t.is("element", "li") || cp(t)) && t._remove()
				}
			}
		}
		...
		function np(e, t, i) {
			if (i.consumable.test(t.viewItem, {
				...
				let i = !1,
					n = !0;
				for (const t of e) i && !cp(t) && t._remove(), t.is("$text") ? (n && (t._data = t.data.trimStart()), t.nextSibling && !cp(t.nextSibling) || (t._data = t.data.trimEnd())) : cp(t) && (i = !0), n = !1
			}
		}
		...
		function ap(e, t, i, n, o, r) {
			const s = Ym(t.nodeBefore, {
					sameIndent: !0,
					smallerIndent: !0,
					listIndent: e,
					foo: "b"
			...
			d = $m(d);
			for (const e of [...n.getChildren()]) cp(e) && (d = c.move(c.createRangeOn(e), d).end, qm(c, e, e.nextSibling), qm(c, e.previousSibling, e))
		}
		...
		class lp extends Qe {
			...
			init() {
				...
				e.model.document.registerPostFixer(t => function(e, t) {
				...
				}(e.model, t)), i.mapper.registerViewToModelLength("li", dp), t.mapper.registerViewToModelLength("li", dp), i.mapper.on("modelToViewPosition", op(i.view)), i.mapper.on("viewToModelPosition", (n = e.model, (e, t) => {
					...
					if ("ul" == o.name || "ol" == o.name) {
						...
						let a = 1,
							c = i.nodeBefore;
						for (; c && cp(c);) a += r.getModelLength(c), c = c.previousSibling;
						t.modelPosition = n.createPositionBefore(s).getShiftedBy(a), e.stop()
					}
				})), t.mapper.on("modelToViewPosition", op(i.view)), e.conversion.for("editingDowncast").add(t => {
					t.on("insert", Xm, {
						priority: "high"
					}), t.on("insert:listItem", Qm(e.model)), t.on("attribute:listType:listItem", Jm, {
						priority: "high"
					}), t.on("attribute:listType:listItem", Zm, {
						priority: "low"
						...
						return (t, i, n) => {
							...
							const s = o.parent,
								a = s.previousSibling,
								c = r.createRangeOn(s);
							r.remove(c), a && a.nextSibling && qm(r, a, a.nextSibling), ap(i.attributeOldValue + 1, i.range.start, c.start, o, n, e), Wm(i.item, o, n, e);
						...
						return (t, i, n) => {
							...
							const s = o.parent,
								...
								c = r.createRangeOn(s),
								l = r.remove(c);
							a && a.nextSibling && qm(r, a, a.nextSibling);
							ap(n.mapper.toModelElement(o).getAttribute("listIndent") + 1, i.position, c.start, o, n, e);
							for (const e of r.createRangeIn(l).getItems()) n.mapper.unbindViewElement(e);
							t.stop()
						}
					}(e.model)), t.on("remove", ep, {
						priority: "low"
					})
				}), e.conversion.for("dataDowncast").add(t => {
					t.on("insert", Xm, {
						priority: "high"
					}), t.on("insert:listItem", Qm(e.model))
				...
				}), e.model.on("insertContent", rp, {
					priority: "high"
				}), e.commands.add("numberedList", new jm(e, "numbered")), e.commands.add("bulletedList", new jm(e, "bulleted")), e.commands.add("indentList", new Hm(e, "forward")), e.commands.add("outdentList", new Hm(e, "backward"));
		...
		function dp(e) {
			...
			for (const i of e.getChildren())
				if ("ul" == i.name || "ol" == i.name)
					for (const e of i.getChildren()) t += dp(e);
			return t
		}
		class up extends Qe {
			static get pluginName() {
		...
		class bp {
			...
			_getMedia(e) {
				if (!e) return new wp(this.locale);
				e = e.trim();
				for (const t of this.providerDefinitions) {
					...
					for (const t of n) {
						...
						if (n) return new wp(this.locale, e, n, i)
					}
				}
				return null
			}
		...
		class kp extends Qe {
			...
			constructor(e) {
				...
				}), this.registry = new bp(e.locale, e.config.get("mediaEmbed"))
			}
			init() {
				const e = this.editor,
					t = e.model.schema,
					...
					s = this.registry;
				e.commands.add("mediaEmbed", new pp(e)), t.register("media", {
					isObject: !0,
					isBlock: !0,
					allowWhere: "$block",
					allowAttributes: ["url"]
					...
					view: (e, {
						...
						return function(e, t, i) {
							return t.setCustomProperty("media", !0, e), Wu(e, t, {
								label: i
							})
						}(fp(t, s, n, {
							elementName: r,
				...
				}), n.for("editingDowncast").add(hp(s, {
					elementName: r,
					renderForEditingView: !0
				})), n.for("upcast").elementToElement({
					view: e => ["oembed", r].includes(e.name) && e.getAttribute("url") ? {
						name: !0
					} : null,
					model: (e, {
						writer: t
						...
						const i = e.getAttribute("url");
						if (s.hasMedia(i)) return t.createElement("media", {
							url: i
						})
					}
				}).elementToElement({
		...
		class vp extends Qe {
			...
			init() {
				...
				this.listenTo(e.plugins.get("ClipboardPipeline"), "inputTransformation", () => {
					const e = t.selection.getFirstRange(),
						i = el.fromPosition(e.start);
					i.stickiness = "toPrevious";
					const n = el.fromPosition(e.end);
			...
			_embedMediaBetweenPositions(e, t) {
				...
				if (s = s.trim(), !s.match(_p)) return void o.detach();
				if (!n.hasMedia(s)) return void o.detach();
				i.commands.get("mediaEmbed").isEnabled ? (this._positionToInsert = el.fromPosition(e), this._timeoutId = _r.window.setTimeout(() => {
					i.model.change(e => {
						let t;
						this._timeoutId = null, e.remove(o), o.detach(), "$graveyard" !== this._positionToInsert.root.rootName && (t = this._positionToInsert), mp(i.model, s, t), this._positionToInsert.detach(), this._positionToInsert = null
					})
				}, 100)) : o.detach()
			}
		}
		...
		class xp extends Qe {
			...
			init() {
				const e = this.editor,
					...
					i = e.plugins.get(kp).registry;
				e.ui.componentFactory.add("mediaEmbed", n => {
					const o = Rd(n),
						r = new yp(function(e, t) {
							return [t => {
		...
		function Ip(e, t) {
			const i = new DOMParser,
				n = function(e) {
					return Mp(Mp(e)).replace(/(<span\s+style=['"]mso-spacerun:yes['"]>[^\S\r\n]*?)[\r\n]+([^\S\r\n]*<\/span>)/g, "$1$2").replace(/<span\s+style=['"]mso-spacerun:yes['"]><\/span>/g, "").replace(/ <\//g, " </").replace(/ <o:p><\/o:p>/g, " <o:p></o:p>").replace(/<o:p>(&nbsp;|\u00A0)<\/o:p>/g, "").replace(/>([^\S\r\n]*[\r\n]\s*)</g, "><")
				}(function(e) {
		...
		const Rp = /<meta\s*name="?generator"?\s*content="?microsoft\s*word\s*\d+"?\/?>/i,
			Op = /xmlns:o="urn:schemas-microsoft-com/i;
		class Dp {
			constructor(e) {
				this.document = e
			}
			isActive(e) {
				return Rp.test(e) || Op.test(e)
			}
			execute(e) {
				const {
					body: t,
					stylesString: i
				} = Ip(e.dataTransfer.getData("text/html"), this.document.stylesProcessor);
				Ap(t, i), Np(t, e.dataTransfer.getData("text/rtf")), e.content = t
			}
		}

		function Lp(e, t, i, n, o = 1) {
				...
				e.on("element:table", (e, t, i) => {
					...
					if (i.safeInsert(c, t.modelCursor)) {
						if (i.consumable.consume(n, {
								name: !0
							}), o.forEach(e => i.convertItem(e, i.writer.createPositionAt(c, "end"))), i.convertChildren(n, i.writer.createPositionAt(c, "end")), c.isEmpty) {
							const e = i.writer.createElement("tableRow");
							i.writer.insert(e, i.writer.createPositionAt(c, "end")), zp(i.writer, i.writer.createPositionAt(e, "end"))
						}
		...
		function Wp(e = {}) {
			return t => t.on("insert:table", (t, i, n) => {
				...
				let c;
				var l, d;
				n.writer.insert(n.writer.createPositionAt(s, 0), a), r && (l = s, (d = n.writer).setCustomProperty("table", !0, l), c = Wu(l, d, {
				...
				for (const t of u) {
					const {
						row: i,
						cell: r
					} = t, s = o.getChild(i), c = f.get(i) || Kp(a, s, i, h, n);
					f.set(i, c), n.consumable.consume(r, "insert");
					Gp(t, h, n.writer.createPositionAt(c, "end"), n, e)
				}
				for (const e of o.getChildren()) {
					const t = e.index;
					e.is("element", "tableRow") && !f.has(t) && f.set(t, Kp(a, e, t, h, n))
				}
		...
		function qp(e, t) {
			...
			if (e.parent.is("element", "tableCell")) return $p(e) ? i.createContainerElement("span", {
				style: "display:inline-block"
			}) : i.createContainerElement("p")
		}

		function $p(e) {
			return 1 === e.parent.childCount && !Xp(e)
		}

		function Yp(e, t, i) {
			const {
				cell: n
			} = e, o = Qp(e, t), r = i.mapper.toViewElement(n);
			r && r.name !== o && function(e, t, i) {
				const n = i.writer,
					o = i.mapper.toViewElement(e),
					r = Ku(n.createEditableElement(t, o.getAttributes()), n);
				Yu(r, n, (e, t, i) => i.addClass(en(t.classes), e), (e, t, i) => i.removeClass(en(t.classes), e)), n.insert(n.createPositionAfter(o), r), n.move(n.createRangeIn(o), n.createPositionAt(r, 0)), n.remove(n.createRangeOn(o)), i.mapper.unbindViewElement(o), i.mapper.bindElements(e, r)
			}(n, o, i)
		}

		function Gp(e, t, i, n, o) {
			const r = o && o.asWidget,
				s = Qp(e, t),
				a = r ? Ku(n.writer.createEditableElement(s), n.writer) : n.writer.createContainerElement(s);
			r && Yu(a, n.writer, (e, t, i) => i.addClass(en(t.classes), e), (e, t, i) => i.removeClass(en(t.classes), e));
			const c = e.cell,
				l = c.getChild(0),
				d = 1 === c.childCount && "paragraph" === l.name;
			if (n.writer.insert(i, a), n.mapper.bindElements(c, a), !r && d && !Xp(l)) {
				const e = c.getChild(0);
				n.consumable.consume(e, "insert"), n.mapper.bindElements(e, a)
			}
		}

		function Kp(e, t, i, n, o) {
		...
		function nb(e) {
			const t = tb(e);
			return t.length ? t : ib(e)
		}

		function ob(e) {
			return cb(e.map(e => e.parent.index))
		}

		function rb(e) {
			const t = e[0].findAncestor("table");
			return cb([...new Hp(t)].filter(t => e.includes(t.cell)).map(e => e.column))
		}
		...
		class ub extends Ze {
			...
			refresh() {
				const e = !!nb(this.editor.model.document.selection).length;
				this.isEnabled = e
			}
			execute() {
				const e = this.editor,
		...
		class fb extends Ze {
			...
			refresh() {
				const e = nb(this.editor.model.document.selection);
				this.isEnabled = 1 === e.length
			}
			execute() {
				const e = nb(this.editor.model.document.selection)[0],
		...
		function gb(e, t, i) {
			...
			for (const {
				...
				if (d) {
					...
					i.append(n, f), kb(n, e, t, r, s, i)
				} else(u < n || h < o) && zp(i, i.createPositionAt(f, "end"))
			}
			return function(e, t, i, n, o) {
				const r = parseInt(t.getAttribute("headingRows") || 0);
				if (r > 0) {
					Lp("headingRows", r - i, e, o, 0)
				}
				const s = parseInt(t.getAttribute("headingColumns") || 0);
				if (s > 0) {
					Lp("headingColumns", s - n, e, o, 0)
				}
			}(a, e, n, o, i), a
		}
		...
		function pb(e, t, i) {
			...
			for (const t of u) {
				...
				r === e && void 0 === h && (h = o), void 0 !== h && h === o && n === d && (f = zp(i, t.getPositionBefore(), a))
			}
			return Lp("rowspan", s, e, i), f
		}
		...
		function wb(e, t, i, n) {
			...
			a > 1 && (r.rowspan = a);
			const c = zp(n, n.createPositionAfter(e), r);
			return Lp("colspan", o, e, n), c
		}

		function kb(e, t, i, n, o, r) {
			const s = parseInt(e.getAttribute("colspan") || 1),
				a = parseInt(e.getAttribute("rowspan") || 1);
			if (i + s - 1 > o) {
				Lp("colspan", o - i + 1, e, r, 1)
			}
			if (t + a - 1 > n) {
				Lp("rowspan", n - t + 1, e, r, 1)
			}
		}
			...
			execute() {
				...
				e.change(e => {
					const o = "right" == n || "down" == n,
						...
						a = s.parent;
					! function(e, t, i) {
						Tb(e) || (Tb(t) && i.remove(i.createRangeIn(t)), i.move(i.createRangeIn(e), i.createPositionAt(t, "end")));
						i.remove(e)
					}(s, r, e);
					...
					yb(a.findAncestor("table"), u)
				})
			}
			_getMergeableCell() {
				const e = ib(this.editor.model.document.selection)[0];
				if (!e) return;
				const t = this.editor.plugins.get("TableUtils"),
					i = this.isHorizontal ? function(e, t, i) {
					...
					}(e, this.direction, t) : function(e, t, i) {
						const n = e.parent,
							o = n.parent,
							r = o.getChildIndex(n);
						if ("down" == t && r === i.getRows(o) - 1 || "up" == t && 0 === r) return;
						...
						const d = parseInt(e.getAttribute("rowspan") || 1),
							...
							f = h.find(t => t.cell === e).column,
							g = h.find(({
								row: e,
								cellHeight: i,
								column: n
							}) => n === f && ("down" == t ? e === u : u === e + i));
						return g && g.cell
					}(e, this.direction, t);
				if (!i) return;
		...
		class Pb extends Ze {
			...
			execute() {
				...
				}(this.editor.model.document.selection), i = e.parent.parent, n = [...new Hp(i)], o = {
		...
		class Sb extends Ze {
			...
			execute(e = {}) {
				...
				t.change(e => {
					if (s) {
						const t = mb(n, s, s > a ? a : 0);
						for (const {
								cell: i
							}
							of t) pb(i, s, e)
					}
					Lp("headingRows", s, n, e, 0)
				})
			}
			_isInHeading(e, t) {
		...
		class Mb extends Ze {
			refresh() {
				const e = nb(this.editor.model.document.selection),
					t = this.editor.plugins.get("TableUtils"),
					i = e.length > 0;
				this.isEnabled = i, this.value = i && e.every(e => Vp(t, e))
			}
			execute(e = {}) {
				if (e.forceValue === this.value) return;
				const t = this.editor.model,
		...
		class Ib extends Qe {
			...
			createTable(e, t) {
				...
				return Nb(e, i, 0, parseInt(t.rows) || 2, parseInt(t.columns) || 2), t.headingRows && Lp("headingRows", t.headingRows, i, e, 0), t.headingColumns && Lp("headingColumns", t.headingColumns, i, e, 0), i
			}
			insertRows(e, t = {}) {
				const i = this.editor.model,
					n = t.at || 0,
					...
					a = this.getRows(e),
					l = this.getColumns(e);
				if (n > a) throw new c.a("tableutils-insertrows-insert-out-of-range", this, {
					options: t
				});
				i.change(t => {
					const i = e.getAttribute("headingRows") || 0;
					if (i > n && Lp("headingRows", i + o, e, t, 0), !r && (0 === n || n === a)) return void Nb(t, e, n, o, l);
			...
			insertColumns(e, t = {}) {
				...
				i.change(t => {
					...
					if (0 === n || r === n) {
						for (const i of e.getChildren()) i.is("element", "tableRow") && Rb(o, t, t.createPositionAt(i, n ? "end" : 0));
						return
					}
					const s = new Hp(e, {
						column: n,
					...
					for (const e of s) {
						...
						} else Rb(o, t, e.getPositionBefore())
					}
				})
			}
			removeRows(e, t) {
				...
				i.change(t => {
						...
						! function(e, t, i, n) {
							...
							for (const {
								...
								if (i.has(e)) {
									...
									n.move(n.createRangeOn(t), a), Lp("rowspan", o, t, n), s = t
								} else a && (s = t)
						}(e, s + 1, i, t)
					}
					...
					for (const {
						...
						of n) Lp("rowspan", e, i, t);
					! function(e, t, i, n) {
						const o = e.getAttribute("headingRows") || 0;
						if (t < o) {
							Lp("headingRows", i < o ? o - (i - t + 1) : t, e, n, 0)
						}
					}(e, r, s, t), _b(e, this) || vb(e, this)
				})
			}
			removeColumns(e, t) {
				const i = this.editor.model,
				...
				i.change(t => {
					...
					for (let i = r; i >= n; i--)
						for (const {
							...
							of [...new Hp(e)]) o <= i && r > 1 && o + r > i ? Lp("colspan", r - 1, n, t) : o === i && t.remove(n);
					vb(e, this) || _b(e, this)
				})
			}
			splitCellVertically(e, t = 2) {
				...
				i.change(i => {
					if (r > 1) {
						...
						Rb(r > t ? t - 1 : r - 1, i, i.createPositionAfter(e), a)
					}
					if (r < t) {
						const s = t - r,
							a = [...new Hp(n)],
						...
						const d = {};
						o > 1 && (d.rowspan = o), Rb(s, i, i.createPositionAfter(e), d);
						const u = n.getAttribute("headingColumns") || 0;
						u > c && Lp("headingColumns", u + s, n, i)
					}
				})
			}
				...
				i.change(i => {
					if (s > 1) {
						...
						for (const e of n) {
							...
							n >= r + l && o && s && Rb(1, i, e.getPositionBefore(), u)
						}
					}
					if (s < t) {
						const n = t - s,
						...
						a > 1 && (l.colspan = a), Nb(i, o, r + 1, n, 1, l);
						const d = o.getAttribute("headingRows") || 0;
						d > r && Lp("headingRows", d + n, o, i)
					}
				})
			}
			getColumns(e) {
		...
		function Nb(e, t, i, n, o, r = {}) {
			for (let s = 0; s < n; s++) {
				const n = e.createElement("tableRow");
				e.insert(n, t, i), Rb(o, e, e.createPositionAt(n, "end"), r)
			}
		}

		function Rb(e, t, i, n = {}) {
			for (let o = 0; o < e; o++) zp(t, i, n)
		}
		...
		class Db extends Ze {
			refresh() {
				const e = tb(this.editor.model.document.selection);
				this.isEnabled = sb(e, this.editor.plugins.get(Ib))
			}
			execute() {
				const e = this.editor.model,
					t = this.editor.plugins.get(Ib);
				e.change(i => {
					const n = tb(e.document.selection),
						o = n.shift(),
						{
							mergeWidth: r,
							mergeHeight: s
							...
							for (const e of t) {
								...
								n = Vb(e, r, n, "colspan"), o = Vb(e, t, o, "rowspan")
							}
							const {
								row: r,
								column: s
					...
					Lp("colspan", r, o, i), Lp("rowspan", s, o, i);
					for (const e of n) Lb(e, o, i);
					yb(o.findAncestor("table"), t), i.setSelection(o, "in")
				})
			}
		}

		function Lb(e, t, i) {
			zb(e) || (zb(t) && i.remove(i.createRangeIn(t)), i.move(i.createRangeIn(e), i.createPositionAt(t, "end"))), i.remove(e)
		}
		...
		function Fb(e) {
			e.document.registerPostFixer(t => function(e, t) {
				...
				for (const t of i) {
					let i;
					"table" == t.name && "insert" == t.type && (i = t.position.nodeAfter), "tableRow" != t.name && "tableCell" != t.name || (i = t.position.findAncestor("table")), Wb(t) && (i = t.range.start.findAncestor("table")), i && !o.has(i) && (n = Hb(i, e) || n, n = Ub(i, e) || n, o.add(i))
				}
				return n
			}(t, e))
		}
		...
		function Hb(e, t) {
			...
			if (n.length) {
				i = !0;
				for (const e of n) Lp("rowspan", e.rowspan, e.cell, t, 1)
			}
			return i
		}
		...
		function Ub(e, t) {
			...
			if (!r.every(e => e === s)) {
				...
				for (const [o, s] of r.entries()) {
					const r = n - s;
					if (r) {
						for (let i = 0; i < r; i++) zp(t, t.createPositionAt(e.getChild(o), "end"));
						i = !0
					}
				}
			}
		...
		function qb(e) {
			e.document.registerPostFixer(t => function(e, t) {
				const i = t.document.differ.getChanges();
				let n = !1;
				for (const t of i) "insert" == t.type && "table" == t.name && (n = $b(t.position.nodeAfter, e) || n), "insert" == t.type && "tableRow" == t.name && (n = Yb(t.position.nodeAfter, e) || n), "insert" == t.type && "tableCell" == t.name && (n = Gb(t.position.nodeAfter, e) || n), Kb(t) && (n = Gb(t.position.parent, e) || n);
				return n
			}(t, e))
		}
		...
		function $b(e, t) {
			let i = !1;
			for (const n of e.getChildren()) n.is("element", "tableRow") && (i = Yb(n, t) || i);
			return i
		}

		function Yb(e, t) {
			let i = !1;
			for (const n of e.getChildren()) i = Gb(n, t) || i;
			return i
		}
		...
		function Qb(e, t) {
			e.document.registerPostFixer(() => function(e, t) {
				...
				for (const n of i.values())
					for (const i of [...n.getChildren()].filter(e => Jb(e, t))) e.refreshItem(i);
				return !1
			}(e.document.differ, t))
		}
		...
		function Jb(e, t) {
			...
			return !!i && $p(e) !== i.is("element", "span")
		}
			...
			init() {
				...
				i.register("table", {
					...
					e.on("element:figure", (e, t, i) => {
						...
						if (!n || !i.consumable.test(n, {
								name: !0
							})) return;
						const o = Ns(i.convertItem(n, t.modelCursor).modelRange.getItems());
						o && (i.convertChildren(t.viewItem, i.writer.createPositionAt(o, "end")), i.updateConversionResult(o, t))
					})
				}), n.for("upcast").add(jp()), n.for("editingDowncast").add(Wp({
					asWidget: !0
				})), n.for("dataDowncast").add(Wp()), n.for("upcast").elementToElement({
					model: "tableRow",
					view: "tr"
				}), n.for("upcast").add(e => {
					e.on("element:tr", (e, t) => {
					...
					const o = n.parent,
						...
						l = new Map;
					for (const e of a) {
						const t = l.get(s) || Kp(r, n, s, c, i);
						l.set(s, t), i.consumable.consume(e.cell, "insert"), Gp(e, c, i.writer.createPositionAt(t, "end"), i, {
							asWidget: !0
						})
					}
					...
					model: "tableCell",
					view: "th"
				}), n.for("upcast").add(Bp("td")), n.for("upcast").add(Bp("th")), n.for("editingDowncast").add(e => e.on("insert:tableCell", (e, t, i) => {
					const n = t.item;
					if (!i.consumable.consume(n, "insert")) return;
					const o = n.parent,
						r = o.parent,
					...
					for (const e of a)
						if (e.cell === n) {
							...
							return void Gp(e, c, i.writer.createPositionAt(t, o.getChildIndex(n)), i, {
								asWidget: !0
							})
						}
				})), n.for("editingDowncast").elementToElement({
					...
					const o = {
						...
						a = (r > s ? r : s) - 1;
					for (const e of new Hp(n, {
							endColumn: a
						})) Yp(e, o, i)
				})), e.commands.add("insertTable", new eb(e)), e.commands.add("insertTableRowAbove", new ub(e, {
					order: "above"
				})), e.commands.add("insertTableRowBelow", new ub(e, {
					order: "below"
				})), e.commands.add("insertTableColumnLeft", new hb(e, {
					order: "left"
				})), e.commands.add("insertTableColumnRight", new hb(e, {
					order: "right"
				})), e.commands.add("removeTableRow", new Eb(e)), e.commands.add("removeTableColumn", new Pb(e)), e.commands.add("splitTableCellVertically", new fb(e, {
					direction: "vertically"
				})), e.commands.add("splitTableCellHorizontally", new fb(e, {
					direction: "horizontally"
				})), e.commands.add("mergeTableCells", new Db(e)), e.commands.add("mergeTableCellRight", new Cb(e, {
					direction: "right"
				})), e.commands.add("mergeTableCellLeft", new Cb(e, {
					direction: "left"
				})), e.commands.add("mergeTableCellDown", new Cb(e, {
					direction: "down"
				})), e.commands.add("mergeTableCellUp", new Cb(e, {
					direction: "up"
				})), e.commands.add("setTableColumnHeader", new Mb(e)), e.commands.add("setTableRowHeader", new Sb(e)), e.commands.add("selectTableRow", new jb(e)), e.commands.add("selectTableColumn", new Bb(e)), Zb(t), Fb(t), Qb(t, e.editing.mapper), qb(t)
			}
			static get requires() {
				return [Ib]
			}
			...
			_createGridCollection() {
				...
				for (let t = 0; t < 100; t++) {
					const i = Math.floor(t / 10),
						n = t % 10;
					e.push(new tw(this.locale, i + 1, n + 1))
				}
		...
		class iw extends Qe {
			...
			init() {
				...
				e.ui.componentFactory.add("insertTable", i => {
					...
					return o.bind("isEnabled").to(n), o.buttonView.set({
						...
						r || (r = new ew(i), o.panelView.children.add(r), r.delegate("execute").to(o), o.buttonView.on("open", () => {
			...
			_prepareMergeSplitButtonDropdown(e, t, i, n) {
				const o = this.editor,
					...
					a = this._fillDropdownWithListOptions(r, i);
				return r.buttonView.set({
					label: e,
					icon: t,
					tooltip: !0,
			...
			_fillDropdownWithListOptions(e, t) {
				const i = this.editor,
					n = [],
					o = new Zi;
				for (const e of t) nw(e, i, n, o);
				return Od(e, o, i.ui.componentFactory), n
			}
		}

		function nw(e, t, i, n) {
			const o = e.model = new Wd(e.model),
				{
					commandName: r,
					bindIsOn: s
				} = e.model;
		...
		class ow extends Qe {
			...
			getAnchorCell() {
				const e = Ns(this.editor.model.document.selection.getRanges()).getContainedElement();
				return e && e.is("element", "tableCell") ? e : null
			}
			...
			_handleDeleteContent(e, t) {
				const [i, n] = t, o = this.editor.model, r = !n || "backward" == n.direction, s = tb(i);
			...
			_getCellsToSelect(e, t) {
				...
				for (const {
					...
					of new Hp(e.findAncestor("table"), d)) l[t - r].push(i);
				const u = o.row < n.row,
					h = o.column < n.column;
		...
		class rw extends Qe {
			...
			_onCopyCut(e, t) {
				const i = this.editor.plugins.get(ow);
			...
			_onInsertContent(e, t, i) {
				...
				if (!r) return;
				const s = nb(n.document.selection);
				s.length ? (e.stop(), n.change(e => {
					const t = {
						...
						i = function(e, t, i, n) {
							...
							c || !sb(e, n) ? function(e, t, i) {
								...
								aw(e, r, a, i), aw(e, s + 1, a, i), sw(e, n, c, i), sw(e, o + 1, c, i, n)
							}(o, a, i) : (a.lastRow = xb(o, a), a.lastColumn = Ab(o, a));
							return a
						}(s, t, e, o),
					...
					if (this.editor.plugins.get("TableSelection").isEnabled) {
						const t = ab(d.map(t => e.createRangeOn(t)));
						e.setSelection(t)
			...
			_replaceSelectedCellsWithPasted(e, t, i, n, o) {
				...
				for (const e of c) {
					...
					g && (kb(g, t, i, n.lastRow, n.lastColumn, o), l.push(g), d = o.createPositionAfter(g))
				}
		...
		function sw(e, t, i, n, o = 0) {
			if (t < 1) return;
			return mb(e, t, o).filter(({
				column: e,
				cellWidth: t
			}) => cw(e, t, i)).map(({
				cell: e
		...
		class lw extends Qe {
			...
			_getTabHandler(e) {
				const t = this.editor;
				return (i, n) => {
					let o = ib(t.model.document.selection)[0];
					...
					const d = this.editor.plugins.get("TableUtils"),
						u = c === r.childCount - 1,
						h = a === d.getRows(s) - 1;
					if (e && h && u && (t.execute("insertTableRowBelow"), a === d.getRows(s) - 1)) return void t.model.change(e => {
						e.setSelection(e.createRangeOn(s))
					});
					let f;
					if (e && u) {
		...
		class uw extends Qe {
			...
			init() {
				this.editor.editing.view.addObserver(dw), this._enableShiftClickSelection(), this._enableMouseDragSelection()
			}
			_enableShiftClickSelection() {
				const e = this.editor;
				let t = !1;
				const i = e.plugins.get(ow);
				this.listenTo(e.editing.view.document, "mousedown", (n, o) => {
					if (!this.isEnabled || !i.isEnabled) return;
					if (!o.domEvent.shiftKey) return;
					const r = i.getAnchorCell() || ib(e.model.document.selection)[0];
					if (!r) return;
					const s = this._getModelTableCellFromDomEvent(o);
					s && hw(r, s) && (t = !0, i.setCellSelection(r, s), o.preventDefault())
			...
			_enableMouseDragSelection() {
				...
				this.listenTo(e.editing.view.document, "mousedown", (e, i) => {
					...
					a && hw(t, a) && (i = a, n || i == t || (n = !0)), n && (o = !0, r.setCellSelection(t, i), s.preventDefault())
				}), this.listenTo(e.editing.view.document, "mouseup", () => {
		...
		function fw(e) {
			const t = e.getSelectedElement();
			return t && mw(t) ? t : null
		}

		function gw(e) {
			let t = e.getFirstPosition().parent;
			for (; t;) {
				if (t.is("element") && mw(t)) return t;
				t = t.parent
			}
			return null
		}
		...
		function mw(e) {
			return !!e.getCustomProperty("table") && Uu(e)
		}
		const pw = {
			autoRefresh: !0
		};
		class bw {
			constructor(e, t = pw) {
				...
				t.initValue && this._validateTokenValue(t.initValue), this.set("value", t.initValue), this._refresh = "function" == typeof e ? e : () => {
					...
					var t
				}, this._options = Object.assign({}, pw, t)
			}
			init() {
			...
			static create(e, t = pw) {
				return new bw(e, t).init()
			}
		}
		Ke(bw, Ue);
		var ww = bw;
		const kw = /^data:(\S*?);base64,/;
		class _w {
			constructor(e, t, i) {
		...
		class vw {
			...
			upload(e) {
				return new _w(e, this._token, this._apiAddress)
			}
		}
		class yw extends an {
			static get pluginName() {
		...
		class xw extends Cu {}
		xw.builtinPlugins = [class extends Qe {
			static get requires() {
				return [kh, Ou, Sh, xh, zh, ff]
			}
			static get pluginName() {
				return "Essentials"
			}
			...
			init() {
				...
				e && (this.editor.plugins.get(mf).createUploadAdapter = t => new _f(t, e, this.editor.t))
			}
		}, class extends Qe {
			static get pluginName() {
				return "Autoformat"
			...
			_addListAutoformats() {
				const e = this.editor.commands;
				e.get("bulletedList") && vf(this.editor, this, /^[*-]\s$/, "bulletedList"), e.get("numberedList") && vf(this.editor, this, /^1[.|)]\s$/, "numberedList"), e.get("todoList") && vf(this.editor, this, /^\[\s?\]\s$/, "todoList"), e.get("checkTodoList") && vf(this.editor, this, /^\[\s?x\s?\]\s$/, () => {
			...
			_addBasicStylesAutoformats() {
				const e = this.editor.commands;
				if (e.get("bold")) {
					const e = Af(this.editor, "bold");
					yf(this.editor, this, /(?:^|\s)(\*\*)([^*]+)(\*\*)$/g, e), yf(this.editor, this, /(?:^|\s)(__)([^_]+)(__)$/g, e)
				}
				if (e.get("italic")) {
					const e = Af(this.editor, "italic");
					yf(this.editor, this, /(?:^|\s)(\*)([^*_]+)(\*)$/g, e), yf(this.editor, this, /(?:^|\s)(_)([^_]+)(_)$/g, e)
				}
				if (e.get("code")) {
					const e = Af(this.editor, "code");
					yf(this.editor, this, /(`)([^`]+)(`)$/g, e)
				}
				if (e.get("strikethrough")) {
					const e = Af(this.editor, "strikethrough");
					yf(this.editor, this, /(~~)([^~]+)(~~)$/g, e)
				}
			}
			...
			_addBlockQuoteAutoformats() {
				this.editor.commands.get("blockQuote") && vf(this.editor, this, /^>\s$/, "blockQuote")
			}
			_addCodeBlockAutoformats() {
				this.editor.commands.get("codeBlock") && vf(this.editor, this, /^```$/, "codeBlock")
			}
			_addHorizontalLineAutoformats() {
				this.editor.commands.get("horizontalLine") && vf(this.editor, this, /^---$/, "horizontalLine")
			}
		}, class extends Qe {
			static get requires() {
				return [Tf, Ef]
			...
			static get requires() {
				return ["Image", "Link", "CKFinderUploadAdapter", jf, Lf]
			}
		}, class extends an {
			static get pluginName() {
			...
			init() {
				const e = this.editor,
					t = e.editing.view.document,
					i = [];
				i.push(new Dp(t)), i.push(new Sp(t)), e.plugins.get("ClipboardPipeline").on("inputTransformation", (e, t) => {
			...
			afterInit() {
				...
				n && i.register("tableContent", {
					...
					items: n,
					getRelatedElement: gw
				}), o && i.register("table", {
					ariaLabel: t("Table toolbar"),
					items: o,
					getRelatedElement: fw
				})
			}
		}, class extends Qe {
			static get pluginName() {
				...
				const e = this.editor,
					...
					n = function(e) {
						...
						return function(e) {
							...
							for (const i of e)
								if (Kh[i])
									for (const e of Kh[i]) t.add(e);
								else t.add(i);
							return Array.from(t)
						}(e.include.concat(t).filter(n)).filter(n).map(e => Gh[e] || e).map(e => ({
							from: Jh(e.from),
							to: Zh(e.to)
						}))
			...
			toolbar: {
				items: ["heading", "|", "bold", "italic", "link", "bulletedList", "numberedList", "|", "outdent", "indent", "|", "uploadImage", "blockQuote", "insertTable", "mediaEmbed", "fontColor", "backgroundColor", "undo", "redo"]
			},
			image: {
